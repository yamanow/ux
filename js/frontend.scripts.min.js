...
! function (e) {
	...
	function k(e, t) {
		var n = t.target,
			o = t.event,
			i = t.timer;
		m(e.changedTouches, o.identifier) && (K(t), C(n, o, i))
	}
	...
	t.fn.twentytwenty = function (e) {
		...
		return this.each(function () {
			var n = e.default_offset_pct,
				...
				s = '<svg width="16" height="26" viewBox="0 0 16 26" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M2 2L13 13L2 24" stroke-width="3" stroke-miterlimit="10"/></svg>';
			if (a.wrap("<div class='twentytwenty-wrapper twentytwenty-" + i + "'></div>"), !e.no_overlay) {
				a.append("<div class='twentytwenty-overlay'></div>");
				var w = a.find(".twentytwenty-overlay");
				w.append("<div class='twentytwenty-arrow twentytwenty-before-label' data-content='" + e.before_label + "'>" + s + "</div>"), w.append("<div class='twentytwenty-arrow twentytwenty-after-label' data-content='" + e.after_label + "'>" + s + "</div>")
			}
			var d = a.find("img:first"),
				c = a.find("img:last");
			a.append("<div class='twentytwenty-handle ba-handle'></div>");
			var l = a.find(".twentytwenty-handle");
			l.append("<span class='twentytwenty-arrow twentytwenty-" + o + "-arrow ba-arrow' data-ba-arrow-direction='" + o + "'>" + s + "</span>"), l.append("<div class='ba-bar'></div>"), l.append("<span class='twentytwenty-arrow twentytwenty-" + r + "-arrow ba-arrow' data-ba-arrow-direction='" + r + "'>" + s + "</span>"), a.addClass("twentytwenty-container"), d.addClass("twentytwenty-before"), c.addClass("twentytwenty-after");
			var v = function (t) {
					var e = d.width(),
						n = d.height();
					return {
				...
				h = function (t, e) {
					return p("vertical" === i ? (e - _) / g : (t - u) / m, 0, 1)
				};
			...
			var u = 0,
				...
				g = 0,
				b = function (t) {
					(t.distX > t.distY && t.distX < -t.distY || t.distX < t.distY && t.distX > -t.distY) && "vertical" !== i ? t.preventDefault() : (t.distX < t.distY && t.distX < -t.distY || t.distX > t.distY && t.distX > -t.distY) && "vertical" === i && t.preventDefault(), a.addClass("active"), u = a.offset().left, _ = a.offset().top, m = d.width(), g = d.height()
				},
				X = function (t) {
					a.hasClass("active") && (n = h(t.pageX, t.pageY), y(n))
				},
				Y = function () {
					a.removeClass("active")
				},
				x = e.move_with_handle_only ? l : a;
			x.on("movestart", b), x.on("move", X), x.on("moveend", Y), e.move_slider_on_hover && (a.on("mouseenter", b), a.on("mousemove", X), a.on("mouseleave", Y)), l.on("touchmove", function (t) {
				t.preventDefault()
			}), a.find("img").on("mousedown", function (t) {
				t.preventDefault()
			}), e.click_to_move && a.on("click", function (t) {
				u = a.offset().left, _ = a.offset().top, m = d.width(), g = d.height(), n = h(t.pageX, t.pageY), y(n)
			}), t(window).trigger("resize.twentytwenty")
		})
	}
}(jQuery);
this.PIXI = this.PIXI || {};
var _pixi_constants = function (E) {
	"use strict";
	var _ = {
			WEBGL_LEGACY: 0,
			WEBGL: 1,
	...
	return E.BLEND_MODES = N, E.DRAW_MODES = R, E.ENV = _, E.FORMATS = A, E.GC_MODES = U, E.MIPMAP_MODES = P, E.PRECISION = D, E.RENDERER_TYPE = T, E.SCALE_MODES = S, E.TARGETS = O, E.TYPES = I, E.WRAP_MODES = L, E
}({});
Object.assign(this.PIXI, _pixi_constants);
this.PIXI = this.PIXI || {};
var _pixi_math = function (t) {
	"use strict";
	var i = function (t, i) {
	...
	i.prototype.clone = function () {
		...
		this.x = t || 0, this.y = i || (0 !== i ? this.x : 0)
	};
	var s = function (t, i, s, h) {
			void 0 === s && (s = 0), void 0 === h && (h = 0), this._x = s, this._y = h, this.cb = t, this.scope = i
		},
		h = {
			x: {
				configurable: !0
	...
	s.prototype.clone = function (t, i) {
		void 0 === t && (t = null), void 0 === i && (i = null);
		var h = t || this.cb,
			o = i || this.scope;
		return new s(h, o, this._x, this._y)
	}, s.prototype.set = function (t, i) {
		var s = t || 0,
			h = i || (0 !== i ? s : 0);
		this._x === s && this._y === h || (this._x = s, this._y = h, this.cb.call(this.scope))
	...
	}, Object.defineProperties(s.prototype, h);
	var o = 2 * Math.PI,
		n = 180 / Math.PI,
		r = Math.PI / 180,
		e = {
		...
		a = function (t, i, s, h, o, n) {
			void 0 === t && (t = 1), void 0 === i && (i = 0), void 0 === s && (s = 0), void 0 === h && (h = 1), void 0 === o && (o = 0), void 0 === n && (n = 0), this.a = t, this.b = i, this.c = s, this.d = h, this.tx = o, this.ty = n, this.array = null
		},
		c = {
			IDENTITY: {
				configurable: !0
	...
	a.prototype.fromArray = function (t) {
	...
	}, a.prototype.set = function (t, i, s, h, o, n) {
		return this.a = t, this.b = i, this.c = s, this.d = h, this.tx = o, this.ty = n, this
	}, a.prototype.toArray = function (t, i) {
	...
	}, a.prototype.apply = function (t, s) {
		s = s || new i;
		var h = t.x,
			o = t.y;
		return s.x = this.a * h + this.c * o + this.tx, s.y = this.b * h + this.d * o + this.ty, s
	}, a.prototype.applyInverse = function (t, s) {
		s = s || new i;
		var h = 1 / (this.a * this.d + this.c * -this.b),
			o = t.x,
			n = t.y;
		return s.x = this.d * h * o + -this.c * h * n + (this.ty * this.c - this.tx * this.d) * h, s.y = this.a * h * n + -this.b * h * o + (-this.ty * this.a + this.tx * this.b) * h, s
		...
		var i = Math.cos(t),
			...
			o = this.c,
			n = this.tx;
		return this.a = h * i - this.b * s, this.b = h * s + this.b * i, this.c = o * i - this.d * s, this.d = o * s + this.d * i, this.tx = n * i - this.ty * s, this.ty = n * s + this.ty * i, this
	}, a.prototype.append = function (t) {
		var i = this.a,
			s = this.b,
			h = this.c,
			o = this.d;
		return this.a = t.a * i + t.b * h, this.b = t.a * s + t.b * o, this.c = t.c * i + t.d * h, this.d = t.c * s + t.d * o, this.tx = t.tx * i + t.ty * h + this.tx, this.ty = t.tx * s + t.ty * o + this.ty, this
	}, a.prototype.setTransform = function (t, i, s, h, o, n, r, e, a) {
		return this.a = Math.cos(r + a) * o, this.b = Math.sin(r + a) * o, this.c = -Math.sin(r - e) * n, this.d = Math.cos(r - e) * n, this.tx = t - (s * this.a + h * this.c), this.ty = i - (s * this.b + h * this.d), this
	}, a.prototype.prepend = function (t) {
		var i = this.tx;
		if (1 !== t.a || 0 !== t.b || 0 !== t.c || 1 !== t.d) {
			var s = this.a,
				h = this.c;
			this.a = s * t.a + this.b * t.c, this.b = s * t.b + this.b * t.d, this.c = h * t.a + this.d * t.c, this.d = h * t.b + this.d * t.d
		}
		return this.tx = i * t.a + this.ty * t.c + t.tx, this.ty = i * t.b + this.ty * t.d + t.ty, this
	}, a.prototype.decompose = function (t) {
		var i = this.a,
			s = this.b,
			h = this.c,
			n = this.d,
			...
			e = Math.atan2(s, i),
			a = Math.abs(r + e);
		return a < 1e-5 || Math.abs(o - a) < 1e-5 ? (t.rotation = e, t.skew.x = t.skew.y = 0) : (t.rotation = 0, t.skew.x = r, t.skew.y = e), t.scale.x = Math.sqrt(i * i + s * s), t.scale.y = Math.sqrt(h * h + n * n), t.position.x = this.tx, t.position.y = this.ty, t
		...
		var t = this.a,
			...
			o = this.tx,
			n = t * h - i * s;
		return this.a = h / n, this.b = -i / n, this.c = -s / n, this.d = t / n, this.tx = (s * this.ty - h * o) / n, this.ty = -(t * this.ty - i * o) / n, this
	...
	}, c.IDENTITY.get = function () {
		return new a
	}, c.TEMP_MATRIX.get = function () {
		return new a
	...
	! function () {
		for (var t = 0; t < 16; t++) {
			...
			x.push(i);
			for (var s = 0; s < 16; s++)
				for (var h = l(u[t] * u[s] + p[t] * y[s]), o = l(y[t] * u[s] + d[t] * y[s]), n = l(u[t] * p[s] + p[t] * d[s]), r = l(y[t] * p[s] + d[t] * d[s]), e = 0; e < 16; e++)
					if (u[e] === h && y[e] === o && p[e] === n && d[e] === r) {
						i.push(e);
						break
					}
		}
		for (var c = 0; c < 16; c++) {
			var _ = new a;
			_.set(u[c], y[c], p[c], d[c], 0, 0), f.push(_)
		}
	}();
	var _ = {
			E: 0,
		...
		v = function () {
			this.worldTransform = new a, this.localTransform = new a, this.position = new s(this.onChange, this, 0, 0), this.scale = new s(this.onChange, this, 1, 1), this.pivot = new s(this.onChange, this, 0, 0), this.skew = new s(this.updateSkew, this, 0, 0), this._rotation = 0, this._cx = 1, this._sx = 0, this._cy = 0, this._sy = 1, this._localID = 0, this._currentLocalID = 0, this._worldID = 0, this._parentID = 0
		},
		b = {
			rotation: {
				configurable: !0
	...
	v.prototype.onChange = function () {
		this._localID++
	}, v.prototype.updateSkew = function () {
	...
	}, v.prototype.updateLocalTransform = function () {
	...
	}, v.prototype.updateTransform = function (t) {
		var i = this.localTransform;
		if (this._localID !== this._currentLocalID && (i.a = this._cx * this.scale._x, i.b = this._sx * this.scale._x, i.c = this._cy * this.scale._y, i.d = this._sy * this.scale._y, i.tx = this.position._x - (this.pivot._x * i.a + this.pivot._y * i.c), i.ty = this.position._y - (this.pivot._x * i.b + this.pivot._y * i.d), this._currentLocalID = this._localID, this._parentID = -1), this._parentID !== t._worldID) {
			var s = t.worldTransform,
				h = this.worldTransform;
			h.a = i.a * s.a + i.b * s.c, h.b = i.a * s.b + i.b * s.d, h.c = i.c * s.a + i.d * s.c, h.d = i.c * s.b + i.d * s.d, h.tx = i.tx * s.a + i.ty * s.c + s.tx, h.ty = i.tx * s.b + i.ty * s.d + s.ty, this._parentID = t._worldID, this._worldID++
		}
	}, v.prototype.setFromMatrix = function (t) {
		t.decompose(this), this._localID++
	}, b.rotation.get = function () {
		return this._rotation
	}, b.rotation.set = function (t) {
		this._rotation !== t && (this._rotation = t, this.updateSkew())
	}, Object.defineProperties(v.prototype, b), v.IDENTITY = new v;
	var w = function (t, i, s, h) {
			void 0 === t && (t = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), void 0 === h && (h = 0), this.x = Number(t), this.y = Number(i), this.width = Number(s), this.height = Number(h), this.type = e.RECT
		},
		g = {
			left: {
				configurable: !0
	...
	g.left.get = function () {
		...
		this.x = i, this.width = Math.max(s - i, 0), this.y = h, this.height = Math.max(o - h, 0)
	}, w.prototype.ceil = function (t, i) {
		void 0 === t && (t = 1), void 0 === i && (i = .001);
		var s = Math.ceil((this.x + this.width - i) * t) / t,
			h = Math.ceil((this.y + this.height - i) * t) / t;
		this.x = Math.floor((this.x + i) * t) / t, this.y = Math.floor((this.y + i) * t) / t, this.width = s - this.x, this.height = h - this.y
	}, w.prototype.enlarge = function (t) {
		...
		this.x = i, this.width = s - i, this.y = h, this.height = o - h
	}, Object.defineProperties(w.prototype, g), Object.defineProperties(w, I);
	var M = function (t, i, s) {
		void 0 === t && (t = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), this.x = t, this.y = i, this.radius = s, this.type = e.CIRC
	};
	M.prototype.clone = function () {
		return new M(this.x, this.y, this.radius)
	}, M.prototype.contains = function (t, i) {
		if (this.radius <= 0) return !1;
		var s = this.radius * this.radius,
			h = this.x - t,
			o = this.y - i;
		return h *= h, o *= o, h + o <= s
	}, M.prototype.getBounds = function () {
		return new w(this.x - this.radius, this.y - this.radius, 2 * this.radius, 2 * this.radius)
	};
	var m = function (t, i, s, h) {
		void 0 === t && (t = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), void 0 === h && (h = 0), this.x = t, this.y = i, this.width = s, this.height = h, this.type = e.ELIP
	};
	m.prototype.clone = function () {
		...
		return s *= s, h *= h, s + h <= 1
	}, m.prototype.getBounds = function () {
		return new w(this.x - this.width, this.y - this.height, this.width, this.height)
	};
	var D = function () {
		for (var t = [], s = arguments.length; s--;) t[s] = arguments[s];
		if (Array.isArray(t[0]) && (t = t[0]), t[0] instanceof i) {
			for (var h = [], o = 0, n = t.length; o < n; o++) h.push(t[o].x, t[o].y);
			t = h
		}
		this.points = t, this.type = e.POLY, this.closeStroke = !0
	};
	D.prototype.clone = function () {
		var t = new D(this.points.slice());
		return t.closeStroke = this.closeStroke, t
	}, D.prototype.contains = function (t, i) {
		for (var s = !1, h = this.points.length / 2, o = 0, n = h - 1; o < h; n = o++) {
			var r = this.points[2 * o],
				e = this.points[2 * o + 1],
				a = this.points[2 * n],
				c = this.points[2 * n + 1];
			e > i != c > i && t < (i - e) / (c - e) * (a - r) + r && (s = !s)
		}
		return s
	};
	var T = function (t, i, s, h, o) {
		void 0 === t && (t = 0), void 0 === i && (i = 0), void 0 === s && (s = 0), void 0 === h && (h = 0), void 0 === o && (o = 20), this.x = t, this.y = i, this.width = s, this.height = h, this.radius = o, this.type = e.RREC
	};
	return T.prototype.clone = function () {
		...
		return !1
	}, t.Circle = M, t.DEG_TO_RAD = r, t.Ellipse = m, t.GroupD8 = _, t.Matrix = a, t.ObservablePoint = s, t.PI_2 = o, t.Point = i, t.Polygon = D, t.RAD_TO_DEG = n, t.Rectangle = w, t.RoundedRectangle = T, t.SHAPES = e, t.Transform = v, t
}({});
Object.assign(this.PIXI, _pixi_math);
this.PIXI = this.PIXI || {};
var _pixi_runner = function (t) {
	"use strict";
	var e = function (t) {
	...
	return e.prototype.emit = function (t, e, i, s, n, r, o, h) {
		if (arguments.length > 8) throw new Error("max arguments reached");
		var u = this,
			a = u.name,
			m = u.items;
		this._aliasCount++;
		for (var p = 0, l = m.length; p < l; p++) m[p][a](t, e, i, s, n, r, o, h);
		return m === this.items && this._aliasCount--, this
		...
		return this._name
	}, Object.defineProperties(e.prototype, i), e.prototype.dispatch = e.prototype.emit, e.prototype.run = e.prototype.emit, t.Runner = e, t
}({});
Object.assign(this.PIXI, _pixi_runner);
this.PIXI = this.PIXI || {};
var _pixi_settings = function (e) {
	"use strict";
	var i = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
		n = function (e, i) {
			...
			! function (i) {
				...
				function o(e) {
					...
					var _ = {
						apple: {
							phone: n(t, i) && !n(b, i),
							ipod: n(r, i),
							tablet: !n(t, i) && n(d, i) && !n(b, i),
							device: (n(t, i) || n(r, i) || n(d, i)) && !n(b, i)
						},
						amazon: {
							phone: n(s, i),
							tablet: !n(s, i) && n(l, i),
						...
						android: {
							phone: !n(b, i) && n(s, i) || !n(b, i) && n(a, i),
							tablet: !n(b, i) && !n(s, i) && !n(a, i) && (n(l, i) || n(p, i)),
							device: !n(b, i) && (n(s, i) || n(l, i) || n(a, i) || n(p, i)) || n(/\bokhttp\b/i, i)
						},
						windows: {
							phone: n(b, i),
							tablet: n(f, i),
						...
						other: {
							...
							firefox: n(v, i),
							chrome: n(u, i),
							device: n(c, i) || n(E, i) || n(h, i) || n(v, i) || n(u, i)
						}
					};
				...
				e.exports && "undefined" == typeof window ? e.exports = o : e.exports && "undefined" != typeof window ? (e.exports = o(), e.exports.isMobile = o) : i.isMobile = o()
			}(i)
		}),
		o = (n.isMobile, {
			MIPMAP_TEXTURES: 1,
			...
			SPRITE_MAX_TEXTURES: function (e) {
				var i = !0;
				if (n.tablet || n.phone) {
					if (i = !1, n.apple.device) {
						var o = navigator.userAgent.match(/OS (\d+)_(\d+)?/);
						if (o) {
							parseInt(o[1], 10) >= 11 && (i = !0)
						}
					}
					if (n.android.device) {
						var t = navigator.userAgent.match(/Android\s([0-9.]*)/);
						if (t) {
							parseInt(t[1], 10) >= 7 && (i = !0)
						}
					}
				}
				return i ? e : 4
			...
			PRECISION_FRAGMENT: n.apple.device ? "highp" : "mediump",
			CAN_UPLOAD_SAME_BUFFER: function () {
				return !n.apple.device
			}(),
			CREATE_IMAGE_BITMAP: !1,
			ROUND_PIXELS: !1
		});
	return e.isMobile = n, e.settings = o, e
}({});
Object.assign(this.PIXI, _pixi_settings);
this.PIXI = this.PIXI || {};
var _pixi_ticker = function (t, e) {
	"use strict";
	...
	var i = {
		...
		s = function (t, e, i, s) {
			void 0 === e && (e = null), void 0 === i && (i = 0), void 0 === s && (s = !1), this.fn = t, this.context = e, this.priority = i, this.once = s, this.next = null, this.previous = null, this._destroyed = !1
		};
	...
	var n = function () {
			var t = this;
			this._head = new s(null, null, 1 / 0), this._requestId = null, this._maxElapsedMS = 100, this._minElapsedMS = 0, this.autoStart = !1, this.deltaTime = 1, this.deltaMS = 1 / e.settings.TARGET_FPMS, this.elapsedMS = 1 / e.settings.TARGET_FPMS, this.lastTime = -1, this.speed = 1, this.started = !1, this._protected = !1, this._lastFrame = -1, this._tick = function (e) {
	...
	n.prototype._requestIfNeeded = function () {
		...
		return void 0 === n && (n = i.NORMAL), this._addListener(new s(t, e, n))
	}, n.prototype.addOnce = function (t, e, n) {
		return void 0 === n && (n = i.NORMAL), this._addListener(new s(t, e, n, !0))
		...
		var i;
		if (t > this.lastTime) {
			if (i = this.elapsedMS = t - this.lastTime, i > this._maxElapsedMS && (i = this._maxElapsedMS), i *= this.speed, this._minElapsedMS) {
				var s = t - this._lastFrame | 0;
				if (s < this._minElapsedMS) return;
				this._lastFrame = t - s % this._minElapsedMS
			}
			this.deltaMS = i, this.deltaTime = this.deltaMS * e.settings.TARGET_FPMS;
	...
	return a.init = function (t) {
		...
		t = Object.assign({
			...
			e._ticker.start()
		}, this._ticker = null, this.ticker = t.sharedTicker ? n.shared : new n, t.autoStart && this.start()
	}, a.destroy = function () {
		if (this._ticker) {
			var t = this._ticker;
			this.ticker = null, t.destroy()
		}
	}, t.Ticker = n, t.TickerPlugin = a, t.UPDATE_PRIORITY = i, t
}({}, PIXI);
Object.assign(this.PIXI, _pixi_ticker);
this.PIXI = this.PIXI || {}, this.PIXI.utils = this.PIXI.utils || {};
var _pixi_utils = function (t, e, n) {
	"use strict";
	...
	function o(t, e, n) {
		...
		var u, c, f, p, v, x, d;
		if (r && (s = l(t, e, s, n)), t.length > 80 * n) {
			u = f = t[0], c = p = t[1];
			for (var y = n; y < o; y += n) v = t[y], x = t[y + 1], v < u && (u = v), x < c && (c = x), v > f && (f = v), x > p && (p = x);
			d = Math.max(f - u, p - c), d = 0 !== d ? 1 / d : 0
		}
		return a(s, h, n, u, c, d), h
	}

	function i(t, e, n, r, o) {
		var i, s;
		if (o === S(t, e, n, r) > 0)
			for (i = e; i < n; i += r) s = R(i, t[i], t[i + 1], s);
		else
			for (i = n - r; i >= e; i -= r) s = R(i, t[i], t[i + 1], s);
		return s && C(s, s.next) && (L(s), s = s.next), s
	}
	...
	function s(t, e) {
		...
		var n, r = t;
		do {
			if (n = !1, r.steiner || !C(r, r.next) && 0 !== _(r.prev, r, r.next)) r = r.next;
			else {
	...
	function a(t, e, n, r, o, i, l) {
		if (t) {
			!l && i && y(t, r, o, i);
			for (var p, v, x = t; t.prev !== t.next;)
				if (p = t.prev, v = t.next, i ? u(t, r, o, i) : h(t)) e.push(p.i / n), e.push(t.i / n), e.push(v.i / n), L(t), t = v.next, x = v.next;
				else if ((t = v) === x) {
				l ? 1 === l ? (t = c(s(t), e, n), a(t, e, n, r, o, i, 2)) : 2 === l && f(t, e, n, r, o, i) : a(s(t), e, n, r, o, i, 1);
				break
			}
		}
	}
	...
	function h(t) {
		...
		for (var o = t.next.next; o !== t.prev;) {
			if (w(e.x, e.y, n.x, n.y, r.x, r.y, o.x, o.y) && _(o.prev, o, o.next) >= 0) return !1;
			o = o.next
		}
		return !0
	}
	...
	function u(t, e, n, r) {
		var o = t.prev,
			i = t,
			s = t.next;
		if (_(o, i, s) >= 0) return !1;
		for (var a = o.x < i.x ? o.x < s.x ? o.x : s.x : i.x < s.x ? i.x : s.x, h = o.y < i.y ? o.y < s.y ? o.y : s.y : i.y < s.y ? i.y : s.y, u = o.x > i.x ? o.x > s.x ? o.x : s.x : i.x > s.x ? i.x : s.x, c = o.y > i.y ? o.y > s.y ? o.y : s.y : i.y > s.y ? i.y : s.y, f = m(a, h, e, n, r), l = m(u, c, e, n, r), p = t.prevZ, v = t.nextZ; p && p.z >= f && v && v.z <= l;) {
			if (p !== t.prev && p !== t.next && w(o.x, o.y, i.x, i.y, s.x, s.y, p.x, p.y) && _(p.prev, p, p.next) >= 0) return !1;
			if (p = p.prevZ, v !== t.prev && v !== t.next && w(o.x, o.y, i.x, i.y, s.x, s.y, v.x, v.y) && _(v.prev, v, v.next) >= 0) return !1;
			v = v.nextZ
		}
		for (; p && p.z >= f;) {
			if (p !== t.prev && p !== t.next && w(o.x, o.y, i.x, i.y, s.x, s.y, p.x, p.y) && _(p.prev, p, p.next) >= 0) return !1;
		...
		for (; v && v.z <= l;) {
			if (v !== t.prev && v !== t.next && w(o.x, o.y, i.x, i.y, s.x, s.y, v.x, v.y) && _(v.prev, v, v.next) >= 0) return !1;
			v = v.nextZ
		}
		return !0
	}
	...
	function c(t, e, n) {
		...
		do {
			var o = r.prev,
				i = r.next.next;
			!C(o, i) && E(o, r, r.next, i) && D(o, i) && D(i, o) && (e.push(o.i / n), e.push(r.i / n), e.push(i.i / n), L(r), L(r.next), r = t = i), r = r.next
		} while (r !== t);
		return s(r)
	}
	...
	function f(t, e, n, r, o, i) {
		...
		do {
			for (var u = h.next.next; u !== h.prev;) {
				if (h.i !== u.i && O(h, u)) {
					var c = N(h, u);
					return h = s(h, h.next), c = s(c, c.next), a(h, e, n, r, o, i), void a(c, e, n, r, o, i)
				}
				u = u.next
			}
			h = h.next
	...
	function l(t, e, n, r) {
		var o, a, h, u, c, f = [];
		for (o = 0, a = e.length; o < a; o++) h = e[o] * r, u = o < a - 1 ? e[o + 1] * r : t.length, c = i(t, h, u, r, !1), c === c.next && (c.steiner = !0), f.push(b(c));
		for (f.sort(p), o = 0; o < f.length; o++) v(f[o], n), n = s(n, n.next);
		return n
	}
	...
	function x(t, e) {
		...
		r = n;
		do {
			o >= r.x && r.x >= c && o !== r.x && w(i < f ? o : s, i, c, f, i < f ? s : o, i, r.x, r.y) && (h = Math.abs(i - r.y) / (o - r.x), D(r, t) && (h < l || h === l && (r.x > n.x || r.x === n.x && d(n, r))) && (n = r, l = h)), r = r.next
		} while (r !== u);
		return n
	}
	...
	function y(t, e, n, r) {
		var o = t;
		do {
			null === o.z && (o.z = m(o.x, o.y, e, n, r)), o.prevZ = o.prev, o.nextZ = o.next, o = o.next
		} while (o !== t);
		o.prevZ.nextZ = null, o.prevZ = null, g(o)
	}

	function g(t) {
		var e, n, r, o, i, s, a, h, u = 1;
		do {
			for (n = t, t = null, i = null, s = 0; n;) {
				for (s++, r = n, a = 0, e = 0; e < u && (a++, r = r.nextZ); e++);
				for (h = u; a > 0 || h > 0 && r;) 0 !== a && (0 === h || !r || n.z <= r.z) ? (o = n, n = n.nextZ, a--) : (o = r, r = r.nextZ, h--), i ? i.nextZ = o : t = o, o.prevZ = i, i = o;
				n = r
			}
			i.nextZ = null, u *= 2
		} while (s > 1);
	...
	function m(t, e, n, r, o) {
		return t = 32767 * (t - n) * o, e = 32767 * (e - r) * o, t = 16711935 & (t | t << 8), t = 252645135 & (t | t << 4), t = 858993459 & (t | t << 2), t = 1431655765 & (t | t << 1), e = 16711935 & (e | e << 8), e = 252645135 & (e | e << 4), e = 858993459 & (e | e << 2), e = 1431655765 & (e | e << 1), t | e << 1
	}
	...
	function w(t, e, n, r, o, i, s, a) {
		return (o - s) * (e - a) - (t - s) * (i - a) >= 0 && (t - s) * (r - a) - (n - s) * (e - a) >= 0 && (n - s) * (i - a) - (o - s) * (r - a) >= 0
	}

	function O(t, e) {
		return t.next.i !== e.i && t.prev.i !== e.i && !j(t, e) && (D(t, e) && D(e, t) && M(t, e) && (_(t.prev, t, e.prev) || _(t, e.prev, e)) || C(t, e) && _(t.prev, t, t.next) > 0 && _(e.prev, e, e.next) > 0)
	}
	...
	function E(t, e, n, r) {
		var o = I(_(t, e, n)),
			...
			s = I(_(n, r, t)),
			a = I(_(n, r, e));
		return o !== i && s !== a || (!(0 !== o || !A(t, n, e)) || (!(0 !== i || !A(t, r, e)) || (!(0 !== s || !A(n, t, r)) || !(0 !== a || !A(n, e, r)))))
	}
	...
	function M(t, e) {
		var n = t,
			...
			i = (t.y + e.y) / 2;
		do {
			n.y > i != n.next.y > i && n.next.y !== n.y && o < (n.next.x - n.x) * (i - n.y) / (n.next.y - n.y) + n.x && (r = !r), n = n.next
		} while (n !== t);
		return r
	}
	...
	function N(t, e) {
		var n = new P(t.i, t.x, t.y),
			...
			o = t.next,
			i = e.prev;
		return t.next = e, e.prev = t, n.next = o, o.prev = n, r.next = n, n.prev = r, i.next = r, r.prev = i, r
	}
	...
	function S(t, e, n, r) {
		for (var o = 0, i = e, s = n - r; i < n; i += r) o += (t[s] - t[i]) * (t[i + 1] + t[s + 1]), s = i;
		return o
	}
	...
	function T(t, e, n) {
		if (t && gt.isObject(t) && t instanceof k) return t;
		var r = new k;
		return r.parse(t, e, n), r
	}

	function U(t) {
		return gt.isString(t) && (t = T(t)), t instanceof k ? t.format() : k.prototype.format.call(t)
	}

	function q(t, e) {
		return T(t, !1, !0).resolve(e)
	}

	function F(t, e) {
		return t ? T(t, !1, !0).resolveObject(e) : e
	}
	...
	function z(t) {
		if (!zt) {
			...
			} else window.console && window.console.log("PixiJS " + Xt + " - " + t + " - http://www.pixijs.com/");
			zt = !0
		}
	}

	function X() {
		return void 0 === Bt && (Bt = function () {
			var t = {
				stencil: !0,
			...
			try {
				...
				var n = document.createElement("canvas"),
					...
					o = !(!r || !r.getContextAttributes().stencil);
				if (r) {
	...
	function V(t, e) {
		...
		var n = t >> 16 & 255,
			r = t >> 8 & 255,
			o = 255 & t;
		return n = n * e + .5 | 0, r = r * e + .5 | 0, o = o * e + .5 | 0, (255 * e << 24) + (n << 16) + (r << 8) + o
	}

	function Q(t, e, n, r) {
		return n = n || new Float32Array(4), n[0] = (t >> 16 & 255) / 255, n[1] = (t >> 8 & 255) / 255, n[2] = (255 & t) / 255, (r || void 0 === r) && (n[0] *= e, n[1] *= e, n[2] *= e), n[3] = e, n
	}

	function Y(t, e) {
		void 0 === e && (e = null);
		var n = 6 * t;
		if (e = e || new Uint16Array(n), e.length !== n) throw new Error("Out buffer length is incorrect, got " + e.length + " and expected " + n);
		for (var r = 0, o = 0; r < n; r += 6, o += 4) e[r + 0] = o + 0, e[r + 1] = o + 1, e[r + 2] = o + 2, e[r + 3] = o + 0, e[r + 4] = o + 2, e[r + 5] = o + 3;
		return e
	}
	...
	function it(t) {
		...
		t >>>= e;
		var n = (t > 255) << 3;
		return t >>>= n, e |= n, n = (t > 15) << 2, t >>>= n, e |= n, n = (t > 3) << 1, t >>>= n, (e |= n) | t >> 1
	}

	function st() {
		var t;
		for (t in $t) $t[t].destroy();
		for (t in Gt) Gt[t].destroy()
	}

	function at() {
		var t;
		for (t in $t) delete $t[t];
		for (t in Gt) delete Gt[t]
	}
	...
	function ht(t) {
		var e, n, r, o = t.width,
			...
			f = null;
		for (e = 0; e < u; e += 4) 0 !== h[e + 3] && (n = e / 4 % o, r = ~~(e / 4 / o), null === c.top && (c.top = r), null === c.left ? c.left = n : n < c.left && (c.left = n), null === c.right ? c.right = n + 1 : c.right < n && (c.right = n + 1), null === c.bottom ? c.bottom = r : c.bottom < r && (c.bottom = r));
		return null !== c.top && (o = c.right - c.left, i = c.bottom - c.top + 1, f = s.getImageData(c.left, c.top, o, i)), {
			height: i,
			width: o,
			data: f
		}
	...
	function ct(t, e) {
		...
		e = e || window.location, Qt || (Qt = document.createElement("a")), Qt.href = t, t = Ft.parse(Qt.href);
		var n = !t.port && "" === e.port || t.port === e.port;
		return t.hostname === e.hostname && n && t.protocol === e.protocol ? "" : "anonymous"
	}

	function ft(t, n) {
		var r = e.settings.RETINA_PREFIX.exec(t);
		return r ? parseFloat(r[1]) : void 0 !== n ? n : 1
	}

	function lt(t, e, n) {
		if (void 0 === n && (n = 3), !te[e]) {
			var r = (new Error).stack;
			void 0 === r ? console.warn("PixiJS Deprecation Warning: ", e + "\nDeprecated since v" + t) : (r = r.split("\n").splice(n).join("\n"), console.groupCollapsed ? (console.groupCollapsed("%cPixiJS Deprecation Warning: %c%s", "color:#614108;background:#fffbe6", "font-weight:normal;color:#614108;background:#fffbe6", e + "\nDeprecated since v" + t), console.warn(r), console.groupEnd()) : (console.warn("PixiJS Deprecation Warning: ", e + "\nDeprecated since v" + t), console.warn(r))), te[e] = !0
		}
	}
	var pt = "undefined" != typeof globalThis ? globalThis : "undefined" != typeof window ? window : "undefined" != typeof global ? global : "undefined" != typeof self ? self : {},
		vt = r(function (t) {
			...
			function r(t, e, r, o, i) {
				...
				var s = new n(r, o || t, i),
					h = a ? a + e : e;
				return t._events[h] ? t._events[h].fn ? t._events[h] = [t._events[h], s] : t._events[h].push(s) : (t._events[h] = s, t._eventsCount++), t
			}
			...
			var s = Object.prototype.hasOwnProperty,
				a = "~";
			Object.create && (e.prototype = Object.create(null), (new e).__proto__ || (a = !1)), i.prototype.eventNames = function () {
				var t, e, n = [];
				...
				if (f.fn) {
					...
					for (c = 1, u = new Array(l - 1); c < l; c++) u[c - 1] = s[c];
					f.fn.apply(f.context, u)
				} else {
					var p, v = f.length;
					for (c = 0; c < v; c++) switch (f[c].once && this.removeListener(t, f[c].fn, void 0, !0), l) {
						case 1:
						...
						default:
							if (!u)
								for (p = 1, u = new Array(l - 1); p < l; p++) u[p - 1] = s[p];
				...
				if (s.fn) s.fn !== e || r && !s.once || n && s.context !== n || o(this, i);
				else {
					for (var h = 0, u = [], c = s.length; h < c; h++)(s[h].fn !== e || r && !s[h].once || n && s[h].context !== n) && u.push(s[h]);
					u.length ? this._events[i] = 1 === u.length ? u[0] : u : o(this, i)
				}
				return this
			}, i.prototype.removeAllListeners = function (t) {
				var n;
				return t ? (n = a ? a + t : t, this._events[n] && o(this, n)) : (this._events = new e, this._eventsCount = 0), this
			}, i.prototype.off = i.prototype.removeListener, i.prototype.addListener = i.prototype.on, i.prefixed = a, i.EventEmitter = i, t.exports = i
		}),
		xt = o,
		dt = o;
	o.deviation = function (t, e, n, r) {
		var o = e && e.length,
			i = o ? e[0] * n : t.length,
			s = Math.abs(S(t, 0, i, n));
		if (o)
			for (var a = 0, h = e.length; a < h; a++) {
				var u = e[a] * n,
					c = a < h - 1 ? e[a + 1] * n : t.length;
				s -= Math.abs(S(t, u, c, n))
			}
		var f = 0;
	...
	var yt = r(function (t, e) {
			! function (n) {
				...
				function i(t, e) {
					var n = t.split("@"),
						r = "";
					return n.length > 1 && (r = n[0] + "@", t = n[1]), t = t.replace(N, "."), r + o(t.split("."), e).join(".")
				}
				...
				function a(t) {
					return o(t, function (t) {
						var e = "";
						return t > 65535 && (t -= 65536, e += S(t >>> 10 & 1023 | 55296), t = 56320 | 1023 & t), e += S(t)
					}).join("")
				}
				...
				function c(t, e, n) {
					var r = 0;
					for (t = n ? P(t / E) : t >> 1, t += P(t / e); t > L * _ >> 1; r += w) t = P(t / L);
					return P(r + (L + 1) * t / (t + C))
				}

				function f(t) {
					var e, n, o, i, s, u, f, l, p, v, x = [],
						d = t.length,
						y = 0,
						g = I,
						m = A;
					for (n = t.lastIndexOf(j), n < 0 && (n = 0), o = 0; o < n; ++o) t.charCodeAt(o) >= 128 && r("not-basic"), x.push(t.charCodeAt(o));
					for (i = n > 0 ? n + 1 : 0; i < d;) {
						for (s = y, u = 1, f = w; i >= d && r("invalid-input"), l = h(t.charCodeAt(i++)), (l >= w || l > P((b - y) / u)) && r("overflow"), y += l * u, p = f <= m ? O : f >= m + _ ? _ : f - m, !(l < p); f += w) v = w - p, u > P(b / v) && r("overflow"), u *= v;
						e = x.length + 1, m = c(y - s, e, 0 == s), P(y / e) > b - g && r("overflow"), g += P(y / e), y %= e, x.splice(y++, 0, g)
					}
					return a(x)
				}

				function l(t) {
					var e, n, o, i, a, h, f, l, p, v, x, d, y, g, m, C = [];
					for (t = s(t), d = t.length, e = I, n = 0, a = A, h = 0; h < d; ++h)(x = t[h]) < 128 && C.push(S(x));
					for (o = i = C.length, i && C.push(j); o < d;) {
						for (f = b, h = 0; h < d; ++h)(x = t[h]) >= e && x < f && (f = x);
						for (y = o + 1, f - e > P((b - n) / y) && r("overflow"), n += (f - e) * y, e = f, h = 0; h < d; ++h)
							if (x = t[h], x < e && ++n > b && r("overflow"), x == e) {
								for (l = n, p = w; v = p <= a ? O : p >= a + _ ? _ : p - a, !(l < v); p += w) m = l - v, g = w - v, C.push(S(u(v + m % g, 0))), l = P(m / g);
								C.push(S(u(l, 0))), a = c(n, y, o == i), n = 0, ++o
							}++n, ++e
					}
					return C.join("")
				}
				...
				var x = e && !e.nodeType && e,
					d = t && !t.nodeType && t,
					y = "object" == typeof pt && pt;
				y.global !== y && y.window !== y && y.self !== y || (n = y);
				var g, m, b = 2147483647,
					w = 36,
					O = 1,
					_ = 26,
					C = 38,
				...
				if (g = {
					...
					if (t.exports == x) d.exports = g;
					else
						for (m in g) g.hasOwnProperty(m) && (x[m] = g[m]);
				else n.punycode = g
			}(pt)
		}),
		gt = {
		...
		mt = (gt.isString, gt.isObject, gt.isNull, gt.isNullOrUndefined, function (t, e, n, r) {
			e = e || "&", n = n || "=";
			var o = {};
			...
			s > 0 && a > s && (a = s);
			for (var h = 0; h < a; ++h) {
				var u, c, f, l, p = t[h].replace(i, "%20"),
					v = p.indexOf(n);
				v >= 0 ? (u = p.substr(0, v), c = p.substr(v + 1)) : (u = p, c = ""), f = decodeURIComponent(u), l = decodeURIComponent(c), Z(o, f) ? Array.isArray(o[f]) ? o[f].push(l) : o[f] = [o[f], l] : o[f] = l
			}
			return o
		}),
		bt = function (t) {
		...
		wt = function (t, e, n, r) {
			return e = e || "&", n = n || "=", null === t && (t = void 0), "object" == typeof t ? Object.keys(t).map(function (r) {
				...
				}).join(e) : o + encodeURIComponent(bt(t[r]))
			}).join(e) : r ? encodeURIComponent(bt(r)) + n + encodeURIComponent(bt(t)) : ""
		},
		Ot = r(function (t, e) {
			e.decode = e.parse = mt, e.encode = e.stringify = wt
		}),
		_t = (Ot.decode, Ot.parse, Ot.encode, Ot.stringify, T),
		Ct = q,
		Et = F,
		At = U,
		It = k,
	...
	k.prototype.parse = function (t, e, n) {
		...
		if (a = a.trim(), !n && 1 === t.split("#").length) {
			var h = Mt.exec(a);
			if (h) return this.path = a, this.href = a, this.pathname = h[1], h[2] ? (this.search = h[2], this.query = e ? Ot.parse(this.search.substr(1)) : this.search.substr(1)) : e && (this.search = "", this.query = {}), this
		}
		var u = jt.exec(a);
		if (u) {
			u = u[0];
		...
		if (n || u || a.match(/^\/\/[^@\/]+@[^@\/]+/)) {
			var f = "//" === a.substr(0, 2);
			!f || u && Ut[u] || (a = a.substr(2), this.slashes = !0)
		}
		if (!Ut[u] && (f || u && !qt[u])) {
			for (var l = -1, p = 0; p < St.length; p++) {
				var v = a.indexOf(St[p]); - 1 !== v && (-1 === l || v < l) && (l = v)
			}
			var x, d;
			d = -1 === l ? a.lastIndexOf("@") : a.lastIndexOf("@", l), -1 !== d && (x = a.slice(0, d), a = a.slice(d + 1), this.auth = decodeURIComponent(x)), l = -1;
			for (var p = 0; p < Pt.length; p++) {
				var v = a.indexOf(Pt[p]); - 1 !== v && (-1 === l || v < l) && (l = v)
			...
			if (!y)
				for (var g = this.hostname.split(/\./), p = 0, m = g.length; p < m; p++) {
					var b = g[p];
					if (b && !b.match(Zt)) {
						for (var w = "", O = 0, _ = b.length; O < _; O++) b.charCodeAt(O) > 127 ? w += "x" : w += b[O];
						if (!w.match(Zt)) {
							var C = g.slice(0, p),
								E = g.slice(p + 1),
								A = b.match(kt);
							A && (C.push(A[1]), E.unshift(A[2])), E.length && (a = "/" + E.join(".") + a), this.hostname = C.join(".");
							break
						}
					}
				}
			this.hostname.length > 255 ? this.hostname = "" : this.hostname = this.hostname.toLowerCase(), y || (this.hostname = yt.toASCII(this.hostname));
			var I = this.port ? ":" + this.port : "",
				j = this.hostname || "";
			this.host = j + I, this.href += this.host, y && (this.hostname = this.hostname.substr(1, this.hostname.length - 2), "/" !== a[0] && (a = "/" + a))
		}
		if (!Tt[c])
			for (var p = 0, m = Lt.length; p < m; p++) {
				var D = Lt[p];
				if (-1 !== a.indexOf(D)) {
					var M = encodeURIComponent(D);
					M === D && (M = escape(D)), a = a.split(D).join(M)
				}
			}
		var N = a.indexOf("#"); - 1 !== N && (this.hash = a.substr(N), a = a.slice(0, N));
		var R = a.indexOf("?");
		if (-1 !== R ? (this.search = a.substr(R), this.query = a.substr(R + 1), e && (this.query = Ot.parse(this.query)), a = a.slice(0, R)) : e && (this.search = "", this.query = {}), a && (this.pathname = a), qt[c] && this.hostname && !this.pathname && (this.pathname = "/"), this.pathname || this.search) {
			var I = this.pathname || "",
				L = this.search || "";
			this.path = I + L
		}
		...
		var e = this.protocol || "",
			...
			o = !1,
			i = "";
		this.host ? o = t + this.host : this.hostname && (o = t + (-1 === this.hostname.indexOf(":") ? this.hostname : "[" + this.hostname + "]"), this.port && (o += ":" + this.port)), this.query && gt.isObject(this.query) && Object.keys(this.query).length && (i = Ot.stringify(this.query));
		var s = this.search || i && "?" + i || "";
		return e && ":" !== e.substr(-1) && (e += ":"), this.slashes || (!e || qt[e]) && !1 !== o ? (o = "//" + (o || ""), n && "/" !== n.charAt(0) && (n = "/" + n)) : o || (o = ""), r && "#" !== r.charAt(0) && (r = "#" + r), s && "?" !== s.charAt(0) && (s = "?" + s), n = n.replace(/[?#]/g, function (t) {
			return encodeURIComponent(t)
		}), s = s.replace("#", "%23"), e + o + n + s + r
	}, k.prototype.resolve = function (t) {
		return this.resolveObject(T(t, !1, !0)).format()
		...
		if (t.slashes && !t.protocol) {
			...
			return qt[n.protocol] && n.hostname && !n.pathname && (n.path = n.pathname = "/"), n.href = n.format(), n
		}
		if (t.protocol && t.protocol !== n.protocol) {
			...
			if (n.protocol = t.protocol, t.host || Ut[t.protocol]) n.pathname = t.pathname;
			else {
				for (var l = (t.pathname || "").split("/"); l.length && !(t.host = l.shift()););
				t.host || (t.host = ""), t.hostname || (t.hostname = ""), "" !== l[0] && l.unshift(""), l.length < 2 && l.unshift(""), n.pathname = l.join("/")
			}
		...
		var x = n.pathname && "/" === n.pathname.charAt(0),
			...
			y = d || x || n.host && t.pathname,
			g = y,
			m = n.pathname && n.pathname.split("/") || [],
			l = t.pathname && t.pathname.split("/") || [],
			b = n.protocol && !qt[n.protocol];
		if (b && (n.hostname = "", n.port = null, n.host && ("" === m[0] ? m[0] = n.host : m.unshift(n.host)), n.host = "", t.protocol && (t.hostname = null, t.port = null, t.host && ("" === l[0] ? l[0] = t.host : l.unshift(t.host)), t.host = null), y = y && ("" === l[0] || "" === m[0])), d) n.host = t.host || "" === t.host ? t.host : n.host, n.hostname = t.hostname || "" === t.hostname ? t.hostname : n.hostname, n.search = t.search, n.query = t.query, m = l;
		else if (l.length) m || (m = []), m.pop(), m = m.concat(l), n.search = t.search, n.query = t.query;
			...
			return n.search = t.search, n.query = t.query, gt.isNull(n.pathname) && gt.isNull(n.search) || (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")), n.href = n.format(), n
		}
		if (!m.length) return n.pathname = null, n.search ? n.path = "/" + n.search : n.path = null, n.href = n.format(), n;
		for (var O = m.slice(-1)[0], _ = (n.host || t.host || m.length > 1) && ("." === O || ".." === O) || "" === O, C = 0, E = m.length; E >= 0; E--) O = m[E], "." === O ? m.splice(E, 1) : ".." === O ? (m.splice(E, 1), C++) : C && (m.splice(E, 1), C--);
		if (!y && !g)
			for (; C--; C) m.unshift("..");
		!y || "" === m[0] || m[0] && "/" === m[0].charAt(0) || m.unshift(""), _ && "/" !== m.join("/").substr(-1) && m.push("");
		var A = "" === m[0] || m[0] && "/" === m[0].charAt(0);
		if (b) {
			n.hostname = n.host = A ? "" : m.length ? m.shift() : "";
			var w = !!(n.host && n.host.indexOf("@") > 0) && n.host.split("@");
			w && (n.auth = w.shift(), n.host = n.hostname = w.shift())
		}
		return y = y || n.host && m.length, y && !A && m.unshift(""), m.length ? n.pathname = m.join("/") : (n.pathname = null, n.path = null), gt.isNull(n.pathname) && gt.isNull(n.search) || (n.path = (n.pathname ? n.pathname : "") + (n.search ? n.search : "")), n.auth = t.auth || n.auth, n.slashes = n.slashes || t.slashes, n.href = n.format(), n
	...
	e.settings.RETINA_PREFIX = /@([0-9\.]+)x/, e.settings.FAIL_IF_MAJOR_PERFORMANCE_CAVEAT = !0;
	var Bt, zt = !1,
		Xt = "5.1.5",
		Jt = function () {
		...
		Kt = function (t, n, r) {
			this.canvas = document.createElement("canvas"), this.context = this.canvas.getContext("2d"), this.resolution = r || e.settings.RESOLUTION, this.resize(t, n)
		},
		Vt = {
			width: {
				configurable: !0
	...
	var Qt, Yt = /^\s*data:(?:([\w-]+)\/([\w+.-]+))?(?:;charset=([\w-]+))?(?:;(base64))?,(.*)/i,
		te = {};
	...
	}), t.BaseTextureCache = Gt, t.CanvasRenderTarget = Kt, t.DATA_URI = Yt, t.EventEmitter = vt, t.ProgramCache = Ht, t.TextureCache = $t, t.clearTextureCache = at, t.correctBlendMode = G, t.createIndicesForQuads = Y, t.decomposeDataUri = ut, t.deprecation = lt, t.destroyTextureCache = st, t.determineCrossOrigin = ct, t.earcut = xt, t.getResolutionOfUrl = ft, t.hex2rgb = J, t.hex2string = W, t.isPow2 = ot, t.isWebGLSupported = X, t.log2 = it, t.nextPow2 = rt, t.premultiplyBlendMode = Jt, t.premultiplyRgba = K, t.premultiplyTint = V, t.premultiplyTintToRgba = Q, t.removeItems = tt, t.rgb2hex = $, t.sayHello = z, t.sign = nt, t.skipHello = B, t.string2hex = H, t.trimCanvas = ht, t.uid = et, t.url = Ft, t
}({}, PIXI, PIXI);
Object.assign(this.PIXI.utils, _pixi_utils);
this.PIXI = this.PIXI || {};
var _pixi_display = function (t, i, e, n) {
	"use strict";

	function s(t, i) {
		return t.zIndex === i.zIndex ? t._lastSortedIndex - i._lastSortedIndex : t.zIndex - i.zIndex
	}
	i.settings.SORTABLE_CHILDREN = !1;
	var r = function () {
	...
	r.prototype.isEmpty = function () {
		...
		return this.minX > this.maxX || this.minY > this.maxY ? e.Rectangle.EMPTY : (t = t || new e.Rectangle(0, 0, 1, 1), t.x = this.minX, t.y = this.minY, t.width = this.maxX - this.minX, t.height = this.maxY - this.minY, t)
		...
		var i = this.minX,
			...
			r = t[0],
			o = t[1];
		i = r < i ? r : i, e = o < e ? o : e, n = r > n ? r : n, s = o > s ? o : s, r = t[2], o = t[3], i = r < i ? r : i, e = o < e ? o : e, n = r > n ? r : n, s = o > s ? o : s, r = t[4], o = t[5], i = r < i ? r : i, e = o < e ? o : e, n = r > n ? r : n, s = o > s ? o : s, r = t[6], o = t[7], i = r < i ? r : i, e = o < e ? o : e, n = r > n ? r : n, s = o > s ? o : s, this.minX = i, this.minY = e, this.maxX = n, this.maxY = s
	}, r.prototype.addFrame = function (t, i, e, n, s) {
		var r = t.worldTransform,
			...
			y = o * i + a * e + d,
			_ = h * i + l * e + m;
		p = y < p ? y : p, u = _ < u ? _ : u, c = y > c ? y : c, f = _ > f ? _ : f, y = o * n + a * e + d, _ = h * n + l * e + m, p = y < p ? y : p, u = _ < u ? _ : u, c = y > c ? y : c, f = _ > f ? _ : f, y = o * i + a * s + d, _ = h * i + l * s + m, p = y < p ? y : p, u = _ < u ? _ : u, c = y > c ? y : c, f = _ > f ? _ : f, y = o * n + a * s + d, _ = h * n + l * s + m, p = y < p ? y : p, u = _ < u ? _ : u, c = y > c ? y : c, f = _ > f ? _ : f, this.minX = p, this.minY = u, this.maxX = c, this.maxY = f
	}, r.prototype.addVertexData = function (t, i, e) {
		for (var n = this.minX, s = this.minY, r = this.maxX, o = this.maxY, h = i; h < e; h += 2) {
			var a = t[h],
				l = t[h + 1];
			n = a < n ? a : n, s = l < s ? l : s, r = a > r ? a : r, o = l > o ? l : o
		}
		this.minX = n, this.minY = s, this.maxX = r, this.maxY = o
	}, r.prototype.addVertices = function (t, i, e, n) {
		for (var s = t.worldTransform, r = s.a, o = s.b, h = s.c, a = s.d, l = s.tx, d = s.ty, m = this.minX, p = this.minY, u = this.maxX, c = this.maxY, f = e; f < n; f += 2) {
			var y = i[f],
				_ = i[f + 1],
				x = r * y + h * _ + l,
				g = a * _ + o * y + d;
			m = x < m ? x : m, p = g < p ? g : p, u = x > u ? x : u, c = g > c ? g : c
		}
		this.minX = m, this.minY = p, this.maxX = u, this.maxY = c
	}, r.prototype.addBounds = function (t) {
		var i = this.minX,
			e = this.minY,
			n = this.maxX,
			s = this.maxY;
		this.minX = t.minX < i ? t.minX : i, this.minY = t.minY < e ? t.minY : e, this.maxX = t.maxX > n ? t.maxX : n, this.maxY = t.maxY > s ? t.maxY : s
	}, r.prototype.addBoundsMask = function (t, i) {
		var e = t.minX > i.minX ? t.minX : i.minX,
			n = t.minY > i.minY ? t.minY : i.minY,
			s = t.maxX < i.maxX ? t.maxX : i.maxX,
		...
		if (e <= s && n <= r) {
			var o = this.minX,
				...
				a = this.maxX,
				l = this.maxY;
			this.minX = e < o ? e : o, this.minY = n < h ? n : h, this.maxX = s > a ? s : a, this.maxY = r > l ? r : l
		}
	}, r.prototype.addBoundsArea = function (t, i) {
		var e = t.minX > i.x ? t.minX : i.x,
			n = t.minY > i.y ? t.minY : i.y,
			s = t.maxX < i.x + i.width ? t.maxX : i.x + i.width,
	...
	var o = function (t) {
		function i() {
			t.call(this), this.tempDisplayObjectParent = null, this.transform = new e.Transform, this.alpha = 1, this.visible = !0, this.renderable = !0, this.parent = null, this.worldAlpha = 1, this._lastSortedIndex = 0, this._zIndex = 0, this.filterArea = null, this.filters = null, this._enabledFilters = null, this._bounds = new r, this._boundsID = 0, this._lastBoundsID = -1, this._boundsRect = null, this._localBoundsRect = null, this._mask = null, this._destroyed = !1, this.isSprite = !1
		}
		...
		return i.mixin = function (t) {
			for (var e = Object.keys(t), n = 0; n < e.length; ++n) {
				var s = e[n];
				Object.defineProperty(i.prototype, s, Object.getOwnPropertyDescriptor(t, s))
			}
		}, n._tempDisplayObjectParent.get = function () {
			return null === this.tempDisplayObjectParent && (this.tempDisplayObjectParent = new i), this.tempDisplayObjectParent
		...
		}, i.prototype.getBounds = function (t, i) {
			return t || (this.parent ? (this._recursivePostUpdateTransform(), this.updateTransform()) : (this.parent = this._tempDisplayObjectParent, this.updateTransform(), this.parent = null)), this._boundsID !== this._lastBoundsID && (this.calculateBounds(), this._lastBoundsID = this._boundsID), i || (this._boundsRect || (this._boundsRect = new e.Rectangle), i = this._boundsRect), this._bounds.getRectangle(i)
		}, i.prototype.getLocalBounds = function (t) {
			var i = this.transform,
				n = this.parent;
			this.parent = null, this.transform = this._tempDisplayObjectParent.transform, t || (this._localBoundsRect || (this._localBoundsRect = new e.Rectangle), t = this._localBoundsRect);
			var s = this.getBounds(!1, t);
			return this.parent = n, this.transform = i, s
		}, i.prototype.toGlobal = function (t, i, e) {
			return void 0 === e && (e = !1), e || (this._recursivePostUpdateTransform(), this.parent ? this.displayObjectUpdateTransform() : (this.parent = this._tempDisplayObjectParent, this.displayObjectUpdateTransform(), this.parent = null)), this.worldTransform.apply(t, i)
		}, i.prototype.toLocal = function (t, i, e, n) {
			return i && (t = i.toGlobal(t, e, n)), n || (this._recursivePostUpdateTransform(), this.parent ? this.displayObjectUpdateTransform() : (this.parent = this._tempDisplayObjectParent, this.displayObjectUpdateTransform(), this.parent = null)), this.worldTransform.applyInverse(t, e)
		}, i.prototype.render = function (t) {}, i.prototype.setParent = function (t) {
			if (!t || !t.addChild) throw new Error("setParent: Argument must be a Container");
			return t.addChild(this), t
		}, i.prototype.setTransform = function (t, i, e, n, s, r, o, h, a) {
			return void 0 === t && (t = 0), void 0 === i && (i = 0), void 0 === e && (e = 1), void 0 === n && (n = 1), void 0 === s && (s = 0), void 0 === r && (r = 0), void 0 === o && (o = 0), void 0 === h && (h = 0), void 0 === a && (a = 0), this.position.x = t, this.position.y = i, this.scale.x = e || 1, this.scale.y = n || 1, this.rotation = s, this.skew.x = r, this.skew.y = o, this.pivot.x = h, this.pivot.y = a, this
			...
			return this.transform.rotation * e.RAD_TO_DEG
		}, n.angle.set = function (t) {
			this.transform.rotation = t * e.DEG_TO_RAD
	...
	var h = function (t) {
		function e() {
			t.call(this), this.children = [], this.sortableChildren = i.settings.SORTABLE_CHILDREN, this.sortDirty = !1
		}
		...
		return e.prototype.onChildrenChange = function () {}, e.prototype.addChild = function (t) {
			var i = arguments,
				e = arguments.length;
			if (e > 1)
				for (var n = 0; n < e; n++) this.addChild(i[n]);
			...
			if (t !== i) {
				...
				this.children[e] = i, this.children[n] = t, this.onChildrenChange(e < n ? e : n)
			}
			...
			var e = this.getChildIndex(t);
			n.removeItems(this.children, e, 1), this.children.splice(i, 0, t), this.onChildrenChange(i)
			...
			var i = arguments,
				e = arguments.length;
			if (e > 1)
				for (var s = 0; s < e; s++) this.removeChild(i[s]);
			else {
				var r = this.children.indexOf(t);
				if (-1 === r) return null;
				t.parent = null, t.transform._parentID = -1, n.removeItems(this.children, r, 1), this._boundsID++, this.onChildrenChange(r), t.emit("removed", this), this.emit("childRemoved", t, this, r)
			}
			return t
		}, e.prototype.removeChildAt = function (t) {
			var i = this.getChildAt(t);
			return i.parent = null, i.transform._parentID = -1, n.removeItems(this.children, t, 1), this._boundsID++, this.onChildrenChange(t), i.emit("removed", this), this.emit("childRemoved", i, this, t), i
		}, e.prototype.removeChildren = function (t, i) {
			void 0 === t && (t = 0);
			var e, n = t,
				s = "number" == typeof i ? i : this.children.length,
				r = s - n;
			if (r > 0 && r <= s) {
				e = this.children.splice(n, r);
				for (var o = 0; o < e.length; ++o) e[o].parent = null, e[o].transform && (e[o].transform._parentID = -1);
				this._boundsID++, this.onChildrenChange(t);
				for (var h = 0; h < e.length; ++h) e[h].emit("removed", this), this.emit("childRemoved", e[h], this, h);
				return e
			}
			...
			for (var t = !1, i = 0, e = this.children.length; i < e; ++i) {
				...
				n._lastSortedIndex = i, t || 0 === n.zIndex || (t = !0)
			}
			t && this.children.length > 1 && this.children.sort(s), this.sortDirty = !1
			...
			for (var t = 0; t < this.children.length; t++) {
				...
				i.visible && i.renderable && (i.calculateBounds(), i._mask ? (i._mask.calculateBounds(), this._bounds.addBoundsMask(i._bounds, i._mask._bounds)) : i.filterArea ? this._bounds.addBoundsArea(i._bounds, i.filterArea) : this._bounds.addBounds(i._bounds))
			}
			...
			if (this.visible && !(this.worldAlpha <= 0) && this.renderable)
				if (this._mask || this.filters && this.filters.length) this.renderAdvanced(t);
					...
					this._render(t);
					for (var i = 0, e = this.children.length; i < e; ++i) this.children[i].render(t)
				}
			...
			for (var s = 0, r = this.children.length; s < r; s++) this.children[s].render(t);
			t.batch.flush(), e && t.mask.pop(this, this._mask), i && this._enabledFilters && this._enabledFilters.length && t.filter.pop()
		}, e.prototype._render = function (t) {}, e.prototype.destroy = function (i) {
			t.prototype.destroy.call(this), this.sortDirty = !1;
			var e = "boolean" == typeof i ? i : i && i.children,
				n = this.removeChildren(0, this.children.length);
			if (e)
				for (var s = 0; s < n.length; ++s) n[s].destroy(i)
	...
	return h.prototype.containerUpdateTransform = h.prototype.updateTransform, t.Bounds = r, t.Container = h, t.DisplayObject = o, t
}({}, PIXI, PIXI, PIXI.utils);
Object.assign(this.PIXI, _pixi_display);
this.PIXI = this.PIXI || {};
var _pixi_core = function (t, e, r, i, n, o, s, a) {
	"use strict";
	...
	function c(t, e, r, i) {
		var n = f(t, t.VERTEX_SHADER, e),
			o = f(t, t.FRAGMENT_SHADER, r),
			s = t.createProgram();
	...
	function g() {
		if (bt === Tt || bt.isContextLost()) {
			var t, e = document.createElement("canvas");
			i.settings.PREFER_ENV >= n.ENV.WEBGL2 && (t = e.getContext("webgl2", {})), t || (t = e.getContext("webgl", {}) || e.getContext("experimental-webgl", {}), t ? t.getExtension("WEBGL_draw_buffers") : t = null), bt = t
		}
		return bt
	}
	...
	function m(t, e, r) {
		if ("precision" !== t.substring(0, 9)) {
			var i = e;
			return e === n.PRECISION.HIGH && r !== n.PRECISION.HIGH && (i = n.PRECISION.MEDIUM), "precision " + i + " float;\n" + t
		}
		return r !== n.PRECISION.HIGH && "precision highp" === t.substring(0, 15) ? t.replace("precision highp", "precision mediump") : t
	}
	...
	function T(t, e) {
		...
		for (var r = e.createShader(e.FRAGMENT_SHADER);;) {
			var i = Rt.replace(/%forloop%/gi, b(t));
	...
	function w() {
		if ("boolean" == typeof vt) return vt;
		try {
	...
	var C = function (t, r) {
			void 0 === t && (t = 0), void 0 === r && (r = 0), this._width = t, this._height = r, this.destroyed = !1, this.internal = !1, this.onResize = new e.Runner("setRealSize", 2), this.onUpdate = new e.Runner("update"), this.onError = new e.Runner("onError", 1)
		},
		I = {
			valid: {
				configurable: !0
	...
	C.prototype.bind = function (t) {
		...
		return this._height
	}, C.prototype.upload = function (t, e, r) {
		return !1
	}, C.prototype.style = function (t, e, r) {
		return !1
	}, C.prototype.dispose = function () {}, C.prototype.destroy = function () {
	...
	var R = function (t) {
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.crossOrigin = function (t, e, i) {
				void 0 === i && 0 !== e.indexOf("data:") ? t.crossOrigin = r.determineCrossOrigin(e) : !1 !== i && (t.crossOrigin = "string" == typeof i ? i : "anonymous")
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.load = function (t) {
				...
				return void 0 !== t && (this.createBitmap = t), this._load ? this._load : (this._load = new Promise(function (t) {
					...
					var r = e,
						i = r.source,
						n = function () {
							e.destroyed || (i.onload = null, i.onerror = null, e.resize(i.width, i.height), e._load = null, t(e.createBitmap ? e.process() : e))
						};
		...
		F = {
			scaleMode: n.SCALE_MODES.NEAREST,
			format: n.FORMATS.RGBA,
			premultiplyAlpha: !1
		},
		D = function (t) {
			function e(e, o) {
				void 0 === e && (e = null), void 0 === o && (o = null), t.call(this), o = o || {};
				var s = o.premultiplyAlpha,
					a = o.mipmap,
			...
			return o.realWidth.get = function () {
				...
				this.isPowerOfTwo = r.isPow2(this.realWidth) && r.isPow2(this.realHeight)
				...
				this.resource && (this.resource.unbind(this), this.resource.internal && this.resource.destroy(), this.resource = null), this.cacheId && (delete r.BaseTextureCache[this.cacheId], delete r.TextureCache[this.cacheId], this.cacheId = null), this.dispose(), e.removeFromCache(this), this.textureCacheIds = null, this.destroyed = !0
			}, e.prototype.dispose = function () {
				this.emit("dispose", this)
			}, e.from = function (t, i) {
				var n = null;
				"string" == typeof t ? n = t : (t._pixiId || (t._pixiId = "pixiid_" + r.uid()), n = t._pixiId);
				var o = r.BaseTextureCache[n];
				return o || (o = new e(t, i), o.cacheId = n, e.addToCache(o, n)), o
				...
				var s = new P(t, {
					...
					a = t instanceof Float32Array ? n.TYPES.FLOAT : n.TYPES.UNSIGNED_BYTE;
				return new e(s, Object.assign(F, o || {
					width: r,
					height: i,
					type: a
				}))
				...
				if ("string" == typeof t) {
					...
					if (e) {
						...
						return i > -1 && e.textureCacheIds.splice(i, 1), delete r.BaseTextureCache[t], e
					}
				} else if (t && t.textureCacheIds) {
					for (var n = 0; n < t.textureCacheIds.length; ++n) delete r.BaseTextureCache[t.textureCacheIds[n]];
	...
	var N = function (t) {
			function e(e, r) {
				...
				if (this.length = n, this._load = null, i)
					for (var a = 0; a < n; a++) this.addResourceAt(h(i[a], r), a)
			}
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.dispose = function () {
				...
				t.prototype.bind.call(this, e), e.target = n.TARGETS.TEXTURE_2D_ARRAY;
				...
				for (var h = 0; h < n; h++) {
					var u = s[h];
					o[h] < u.dirtyId && (o[h] = u.dirtyId, u.valid && a.texSubImage3D(a.TEXTURE_2D_ARRAY, 0, 0, 0, h, u.resource.width, u.resource.height, 1, e.format, e.type, u.resource.source))
				}
				return !0
			}, e
		}(C),
		...
		B = function (t) {
			function e(r, i) {
				...
				for (var o = 0; o < e.SIDES; o++) this.items[o].target = n.TARGETS.TEXTURE_CUBE_MAP_POSITIVE_X + o;
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.bind = function (e) {
				t.prototype.bind.call(this, e), e.target = n.TARGETS.TEXTURE_CUBE_MAP
	...
	var L = function (t) {
		...
		return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.load = function () {
			...
			t.crossOrigin(i, this.svg, this._crossorigin), i.src = this.svg, i.onerror = function (t) {
				...
				var o = t * e.scale,
					s = n * e.scale;
				(e._overrideWidth || e._overrideHeight) && (o = e._overrideWidth || e._overrideHeight / n * t, s = e._overrideHeight || e._overrideWidth / t * n), o = Math.round(o), s = Math.round(s);
				var a = e.source;
				a.width = o, a.height = s, a._pixiId = "canvas_" + r.uid(), a.getContext("2d").drawImage(i, 0, 0, t, n, 0, 0, o, s), e._resolve(), e._resolve = null
			}
	...
	L.SVG_SIZE = /<svg[^>]*(?:\s(width|height)=('|")(\d*(?:\.\d+)?)(?:px)?('|"))[^>]*(?:\s(width|height)=('|")(\d*(?:\.\d+)?)(?:px)?('|"))[^>]*>/i;
	var k = function (t) {
		function e(e, r) {
		...
		return e.prototype.update = function (e) {
			if (void 0 === e && (e = 0), !this.destroyed) {
				var r = o.Ticker.shared.elapsedMS * this.source.playbackRate;
			...
			this.valid || this._onCanPlay(), !this._isAutoUpdating && this.autoUpdate && (o.Ticker.shared.add(this.update, this), this._isAutoUpdating = !0)
		}, e.prototype._onPlayStop = function () {
			this._isAutoUpdating && (o.Ticker.shared.remove(this.update, this), this._isAutoUpdating = !1)
			...
			this._isAutoUpdating && o.Ticker.shared.remove(this.update, this), this.source && (this.source.removeEventListener("error", this._onError, !0), this.source.pause(), this.source.src = "", this.source.load()), t.prototype.dispose.call(this)
		}, r.autoUpdate.get = function () {
			return this._autoUpdate
		}, r.autoUpdate.set = function (t) {
			t !== this._autoUpdate && (this._autoUpdate = t, !this._autoUpdate && this._isAutoUpdating ? (o.Ticker.shared.remove(this.update, this), this._isAutoUpdating = !1) : this._autoUpdate && !this._isAutoUpdating && (o.Ticker.shared.add(this.update, this), this._isAutoUpdating = !0))
	...
	k.TYPES = ["mp4", "m4v", "webm", "ogg", "ogv", "h264", "avi", "mov"];
	var G = function (t) {
		function e() {
			t.apply(this, arguments)
		}
	...
	M.push(O, G, U, k, L, P, B, N);
	var V = {
			INSTALLED: M,
			autoDetectResource: h,
			ArrayResource: N,
			BufferResource: P,
			CanvasResource: U,
			CubeResource: B,
			ImageResource: O,
			ImageBitmapResource: G,
			SVGResource: L,
			VideoResource: k,
			Resource: C,
			BaseImageResource: R
	...
	var z = function (t) {
		...
		j = function (t, r) {
			this.width = Math.ceil(t || 100), this.height = Math.ceil(r || 100), this.stencil = !1, this.depth = !1, this.dirtyId = 0, this.dirtyFormat = 0, this.dirtySize = 0, this.depthTexture = null, this.colorTextures = [], this.glFramebuffers = {}, this.disposeRunner = new e.Runner("disposeFramebuffer", 2)
		},
		H = {
			colorTexture: {
				configurable: !0
	...
	H.colorTexture.get = function () {
		return this.colorTextures[0]
	}, j.prototype.addColorTexture = function (t, e) {
		return void 0 === t && (t = 0), this.colorTextures[t] = e || new D(null, {
			scaleMode: 0,
			resolution: 1,
			mipmap: !1,
			width: this.width,
	...
	}, j.prototype.addDepthTexture = function (t) {
		return this.depthTexture = t || new D(new z(null, {
			width: this.width,
			height: this.height
		}), {
			scaleMode: 0,
			...
			height: this.height,
			mipmap: !1,
			format: n.FORMATS.DEPTH_COMPONENT,
			type: n.TYPES.UNSIGNED_SHORT
		}), this.dirtyId++, this.dirtyFormat++, this
	}, j.prototype.enableDepth = function () {
		return this.depth = !0, this.dirtyId++, this.dirtyFormat++, this
	}, j.prototype.enableStencil = function () {
	...
	var W = function (t) {
			function e(e) {
				...
				var r = e || {},
					i = r.width,
					n = r.height;
				this.mipmap = !1, this.width = Math.ceil(i) || 100, this.height = Math.ceil(n) || 100, this.valid = !0, this._canvasRenderTarget = null, this.clearColor = [0, 0, 0, 0], this.framebuffer = new j(this.width * this.resolution, this.height * this.resolution).addColorTexture(0, this), this.stencilMaskStack = [], this.filterStack = [{}]
			}
	...
	Y.prototype.set = function (t, e, r) {
		var i = e.width,
			n = e.height;
		if (r) {
			var o = t.width / 2 / i,
				...
				h = t.x / i + o,
				u = t.y / n + a;
			r = s.GroupD8.add(r, s.GroupD8.NW), this.x0 = h + o * s.GroupD8.uX(r), this.y0 = u + a * s.GroupD8.uY(r), r = s.GroupD8.add(r, 2), this.x1 = h + o * s.GroupD8.uX(r), this.y1 = u + a * s.GroupD8.uY(r), r = s.GroupD8.add(r, 2), this.x2 = h + o * s.GroupD8.uX(r), this.y2 = u + a * s.GroupD8.uY(r), r = s.GroupD8.add(r, 2), this.x3 = h + o * s.GroupD8.uX(r), this.y3 = u + a * s.GroupD8.uY(r)
	...
	var K = new Y,
		q = function (t) {
			function e(r, i, n, o, a, h) {
				if (t.call(this), this.noFrame = !1, i || (this.noFrame = !0, i = new s.Rectangle(0, 0, 1, 1)), r instanceof e && (r = r.baseTexture), this.baseTexture = r, this._frame = i, this.trim = o, this.valid = !1, this.requiresUpdate = !1, this._uvs = K, this.uvMatrix = null, this.orig = n || i, this._rotate = Number(a || 0), !0 === a) this._rotate = 2;
				else if (this._rotate % 2 != 0) throw new Error("attempt to use diamond-shaped UVs. If you are sure, set rotation manually");
				this.defaultAnchor = h ? new s.Point(h.x, h.y) : new s.Point(0, 0), this._updateID = 0, this.textureCacheIds = [], r.valid ? this.noFrame ? r.valid && this.onBaseTextureUpdated(r) : this.frame = i : r.once("loaded", this.onBaseTextureUpdated, this), this.noFrame && r.on("update", this.onBaseTextureUpdated, this)
			}
			t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e;
			var n = {
				resolution: {
			...
			return e.prototype.update = function () {
				...
				if (this.baseTexture) {
					if (t) {
						var i = this.baseTexture,
							n = i.resource;
						n && r.TextureCache[n.url] && e.removeFromCache(n.url), this.baseTexture.destroy()
					}
				...
				this._uvs === K && (this._uvs = new Y), this._uvs.set(this._frame, this.baseTexture, this.rotate), this._updateID++
			}, e.from = function (t, i) {
				void 0 === i && (i = {});
				var n = null;
				"string" == typeof t ? n = t : (t._pixiId || (t._pixiId = "pixiid_" + r.uid()), n = t._pixiId);
				var o = r.TextureCache[n];
				return o || (i.resolution || (i.resolution = r.getResolutionOfUrl(t)), o = new e(new D(t, i)), o.baseTexture.cacheId = n, D.addToCache(o.baseTexture, n), e.addToCache(o, n)), o
			}, e.fromBuffer = function (t, r, i, n) {
				return new e(D.fromBuffer(t, r, i, n))
			}, e.fromLoader = function (t, n, o) {
				var s = new O(t);
				s.url = n;
				var a = new D(s, {
						scaleMode: i.settings.SCALE_MODE,
						resolution: r.getResolutionOfUrl(n)
					}),
					h = new e(a);
				return o || (o = n), D.addToCache(h.baseTexture, o), e.addToCache(h, o), o !== n && (D.addToCache(h.baseTexture, n), e.addToCache(h, n)), h
			}, e.addToCache = function (t, e) {
				...
				if ("string" == typeof t) {
					...
					if (e) {
						var i = e.textureCacheIds.indexOf(t);
						return i > -1 && e.textureCacheIds.splice(i, 1), delete r.TextureCache[t], e
					}
				} else if (t && t.textureCacheIds) {
					for (var n = 0; n < t.textureCacheIds.length; ++n) r.TextureCache[t.textureCacheIds[n]] === t && delete r.TextureCache[t.textureCacheIds[n]];
					return t.textureCacheIds.length = 0, t
				}
				return null
	...
	q.EMPTY = new q(new D), u(q.EMPTY), u(q.EMPTY.baseTexture), q.WHITE = function () {
		var t = document.createElement("canvas");
		t.width = 16, t.height = 16;
		var e = t.getContext("2d");
		return e.fillStyle = "white", e.fillRect(0, 0, 16, 16), new q(new D(new U(t)))
	}(), u(q.WHITE), u(q.WHITE.baseTexture);
	var Z = function (t) {
			function e(e, r) {
				var i = null;
				if (!(e instanceof W)) {
					var n = arguments[1],
						...
						s = arguments[3],
						a = arguments[4];
					console.warn("Please use RenderTexture.create(" + n + ", " + o + ") instead of the ctor directly."), i = arguments[0], r = null, e = new W({
						width: n,
						height: o,
						scaleMode: s,
						resolution: a
	...
	Q.prototype.createTexture = function (t, e) {
		var r = new W(Object.assign({
			width: t,
			height: e,
			resolution: 1
		}, this.textureOptions));
		return new Z(r)
	}, Q.prototype.getOptimalTexture = function (t, e, i) {
		void 0 === i && (i = 1);
		var n = Q.SCREEN_KEY;
		t *= i, e *= i, this.enableFullScreen && t === this._pixelsWidth && e === this._pixelsHeight || (t = r.nextPow2(t), e = r.nextPow2(e), n = (65535 & t) << 16 | 65535 & e), this.texturePool[n] || (this.texturePool[n] = []);
		var o = this.texturePool[n].pop();
		return o || (o = this.createTexture(t, e)), o.filterPoolKey = n, o.setResolution(i), o
	}, Q.prototype.getFilterTexture = function (t, e) {
		var r = this.getOptimalTexture(t.width, t.height, e || t.resolution);
		return r.filterFrame = t.filterFrame, r
	}, Q.prototype.returnTexture = function (t) {
		var e = t.filterPoolKey;
		t.filterFrame = null, this.texturePool[e].push(t)
	}, Q.prototype.returnFilterTexture = function (t) {
		...
		this.texturePool = {}
	}, Q.prototype.setScreenSize = function (t) {
	...
	$.prototype.destroy = function () {
		this.buffer = null
	}, $.from = function (t, e, r, i, n) {
		return new $(t, e, r, i, n)
	};
	var J = 0,
		tt = function (t, r, i) {
			void 0 === r && (r = !0), void 0 === i && (i = !1), this.data = t || new Float32Array(1), this._glBuffers = {}, this._updateID = 0, this.index = i, this.static = r, this.id = J++, this.disposeRunner = new e.Runner("disposeBuffer", 2)
		};
	...
	var et = {
		...
		ot = function (t, r) {
			void 0 === t && (t = []), void 0 === r && (r = {}), this.buffers = t, this.indexBuffer = null, this.attributes = r, this.glVertexArrayObjects = {}, this.id = it++, this.instanced = !1, this.instanceCount = 1, this.disposeRunner = new e.Runner("disposeGeometry", 2), this.refCount = 0
		};
	ot.prototype.addAttribute = function (t, e, r, i, n, o, s, a) {
		if (void 0 === i && (i = !1), void 0 === a && (a = !1), !e) throw new Error("You must pass a buffer when creating an attribute");
		e.data || (e instanceof Array && (e = new Float32Array(e)), e = new tt(e));
		var h = t.split("|");
		if (h.length > 1) {
		...
		return -1 === l && (this.buffers.push(e), l = this.buffers.length - 1), this.attributes[t] = new $(l, r, i, n, o, s, a), this.instanced = this.instanced || a, this
	}, ot.prototype.getAttribute = function (t) {
		return this.attributes[t]
	}, ot.prototype.getBuffer = function (t) {
		return this.buffers[this.getAttribute(t).buffer]
	}, ot.prototype.addIndex = function (t) {
		return t.data || (t instanceof Array && (t = new Uint16Array(t)), t = new tt(t)), t.index = !0, this.indexBuffer = t, -1 === this.buffers.indexOf(t) && this.buffers.push(t), this
	}, ot.prototype.getIndex = function () {
		return this.indexBuffer
	}, ot.prototype.interleave = function () {
		...
		for (t in this.attributes) {
			...
			e.push(o.data), r.push(n.size * rt[n.type] / 4), n.buffer = 0
		}
		for (i.data = d(e, r), t = 0; t < this.buffers.length; t++) this.buffers[t] !== this.indexBuffer && this.buffers[t].destroy();
		...
		for (var t = new ot, e = 0; e < this.buffers.length; e++) t.buffers[e] = new tt(this.buffers[e].data.slice());
		for (var r in this.attributes) {
			var i = this.attributes[r];
			t.attributes[r] = new $(i.buffer, i.size, i.normalized, i.type, i.stride, i.start, i.instance)
		}
		return this.indexBuffer && (t.indexBuffer = t.buffers[this.buffers.indexOf(this.indexBuffer)], t.indexBuffer.index = !0), t
	}, ot.merge = function (t) {
		for (var e, r = new ot, i = [], n = [], o = [], s = 0; s < t.length; s++) {
			e = t[s];
			for (var a = 0; a < e.buffers.length; a++) n[a] = n[a] || 0, n[a] += e.buffers[a].data.length, o[a] = 0
		}
		for (var h = 0; h < e.buffers.length; h++) i[h] = new(nt[l(e.buffers[h].data)])(n[h]), r.buffers[h] = new tt(i[h]);
		for (var u = 0; u < t.length; u++) {
			e = t[u];
			for (var d = 0; d < e.buffers.length; d++) i[d].set(e.buffers[d].data, o[d]), o[d] += e.buffers[d].data.length
		}
		if (r.attributes = e.attributes, e.indexBuffer) {
			r.indexBuffer = r.buffers[e.buffers.indexOf(e.indexBuffer)], r.indexBuffer.index = !0;
			for (var c = 0, f = 0, p = 0, v = 0, g = 0; g < e.buffers.length; g++)
				if (e.buffers[g] !== e.indexBuffer) {
					v = g;
					break
				}
			for (var _ in e.attributes) {
				var m = e.attributes[_];
				(0 | m.buffer) === v && (f += m.size * rt[m.type] / 4)
			}
			for (var y = 0; y < t.length; y++) {
				for (var x = t[y].indexBuffer.data, E = 0; E < x.length; E++) r.indexBuffer.data[E + p] += c;
				c += e.buffers[v].data.length / f, p += x.length
			}
		}
		return r
	};
	var st = function (t) {
		...
		at = function (t) {
			function e() {
				t.call(this), this.vertices = new Float32Array([-1, -1, 1, -1, 1, 1, -1, 1]), this.uvs = new Float32Array([0, 0, 1, 0, 1, 1, 0, 1]), this.vertexBuffer = new tt(this.vertices), this.uvBuffer = new tt(this.uvs), this.addAttribute("aVertexPosition", this.vertexBuffer).addAttribute("aTextureCoord", this.uvBuffer).addIndex([0, 1, 2, 0, 2, 3])
			}
		...
		ht = 0,
		ut = function (t, e) {
			this.uniforms = t, this.group = !0, this.syncUniforms = {}, this.dirtyId = 0, this.id = ht++, this.static = !!e
		};
	ut.prototype.update = function () {
		this.dirtyId++
	}, ut.prototype.add = function (t, e, r) {
		this.uniforms[t] = new ut(e, r)
	}, ut.from = function (t, e) {
		return new ut(t, e)
	};
	var lt = function () {
		this.renderTexture = null, this.target = null, this.legacy = !1, this.resolution = 1, this.sourceFrame = new s.Rectangle, this.destinationFrame = new s.Rectangle, this.filters = []
	};
	...
	var dt = function (t) {
			function e(e) {
				t.call(this, e), this.defaultFilterStack = [{}], this.texturePool = new Q, this.texturePool.setScreenSize(e.view), this.statePool = [], this.quad = new st, this.quadUv = new at, this.tempRect = new s.Rectangle, this.activeState = {}, this.globalUniforms = new ut({
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.push = function (t, e) {
				for (var r = this.renderer, i = this.defaultFilterStack, n = this.statePool.pop() || new lt, o = e[0].resolution, s = e[0].padding, a = e[0].autoFit, h = e[0].legacy, u = 1; u < e.length; u++) {
					var l = e[u];
				...
				if (1 === r.length) r[0].apply(this, e.renderTexture, h.renderTexture, !1, e), this.returnFilterTexture(e.renderTexture);
					...
					for (d = 0; d < r.length - 1; ++d) {
						r[d].apply(this, u, l, !0, e);
						var c = u;
						u = l, l = c
					}
					r[d].apply(this, u, h.renderTexture, !1, e), this.returnFilterTexture(u), this.returnFilterTexture(l)
				}
				...
				var r = this.activeState,
					...
					o = e._texture,
					a = o.orig,
					h = t.set(n.width, 0, 0, n.height, i.x, i.y),
					u = e.worldTransform.copyTo(s.Matrix.TEMP_MATRIX);
				return u.invert(), h.prepend(u), h.scale(1 / a.width, 1 / a.height), h.translate(e.anchor.x, e.anchor.y), h
			}, e.prototype.destroy = function () {
	...
	ct.prototype.flush = function () {}, ct.prototype.destroy = function () {
		this.renderer = null
	}, ct.prototype.start = function () {}, ct.prototype.stop = function () {
		this.flush()
	}, ct.prototype.render = function (t) {};
	var ft = function (t) {
		function e(e) {
			t.call(this, e), this.emptyRenderer = new ct(e), this.currentRenderer = this.emptyRenderer
		}
	...
	i.settings.PREFER_ENV = r.isMobile.any ? n.ENV.WEBGL : n.ENV.WEBGL2;
	var pt, vt, gt = 0,
		_t = function (t) {
			function e(e) {
			...
			return r.isLost.get = function () {
				...
				this.gl = t, this.renderer.gl = t, this.renderer.CONTEXT_UID = gt++, t.isContextLost() && t.getExtension("WEBGL_lose_context") && t.getExtension("WEBGL_lose_context").restoreContext()
			}, e.prototype.initFromContext = function (t) {
				this.gl = t, this.validateContext(t), this.renderer.gl = t, this.renderer.CONTEXT_UID = gt++, this.renderer.runners.contextChange.run(t)
			}, e.prototype.initFromOptions = function (t) {
				var e = this.createContext(this.renderer.view, t);
				this.initFromContext(e)
			}, e.prototype.createContext = function (t, e) {
				var r;
				if (i.settings.PREFER_ENV >= n.ENV.WEBGL2 && (r = t.getContext("webgl2", e)), r) this.webGLVersion = 2;
		...
		mt = function (t) {
			function e(e) {
				t.call(this, e), this.managedFramebuffers = [], this.unknownFramebuffer = new j(10, 10)
			}
			t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e;
			var r = {
				size: {
			...
			return e.prototype.contextChange = function () {
				...
				if (this.CONTEXT_UID = this.renderer.CONTEXT_UID, this.current = this.unknownFramebuffer, this.viewport = new s.Rectangle, this.hasMRT = !0, this.writeDepthTexture = !0, this.disposeAll(!0), 1 === this.renderer.context.webGLVersion) {
					var e = this.renderer.context.extensions.drawBuffers,
						r = this.renderer.context.extensions.depthTexture;
					i.settings.PREFER_ENV === n.ENV.WEBGL_LEGACY && (e = null, r = null), e ? t.drawBuffers = function (t) {
				...
				if (t) {
					...
					for (var o = 0; o < t.colorTextures.length; o++) t.colorTextures[o].texturePart ? this.renderer.texture.unbind(t.colorTextures[o].texture) : this.renderer.texture.unbind(t.colorTextures[o]);
				...
				var n = this,
					o = n.gl;
				o.clearColor(t, e, r, i), o.clear(o.COLOR_BUFFER_BIT | o.DEPTH_BUFFER_BIT)
			}, e.prototype.initFramebuffer = function (t) {
				var e = this,
					r = e.gl,
					i = {
						framebuffer: r.createFramebuffer(),
						stencil: null,
						dirtyId: 0,
						dirtyFormat: 0,
						dirtySize: 0
				...
				i.stencil && (r.bindRenderbuffer(r.RENDERBUFFER, i.stencil), r.renderbufferStorage(r.RENDERBUFFER, r.DEPTH_STENCIL, t.width, t.height));
				for (var n = t.colorTextures, o = 0; o < n.length; o++) this.renderer.texture.bind(n[o], 0);
				...
				for (var s = [], a = 0; a < o; a++) {
					...
					h.texturePart ? (this.renderer.texture.bind(h.texture, 0), r.framebufferTexture2D(r.FRAMEBUFFER, r.COLOR_ATTACHMENT0 + a, r.TEXTURE_CUBE_MAP_NEGATIVE_X + h.side, h.texture._glTextures[this.CONTEXT_UID].texture, 0)) : (this.renderer.texture.bind(h, 0), r.framebufferTexture2D(r.FRAMEBUFFER, r.COLOR_ATTACHMENT0 + a, r.TEXTURE_2D, h._glTextures[this.CONTEXT_UID].texture, 0)), s.push(r.COLOR_ATTACHMENT0 + a)
				}
				if (s.length > 1 && r.drawBuffers(s), t.depthTexture) {
					if (this.writeDepthTexture) {
						var u = t.depthTexture;
						this.renderer.texture.bind(u, 0), r.framebufferTexture2D(r.FRAMEBUFFER, r.DEPTH_ATTACHMENT, r.TEXTURE_2D, u._glTextures[this.CONTEXT_UID].texture, 0)
					}
				}
				i.stencil || !t.stencil && !t.depth || (i.stencil = r.createRenderbuffer(), r.bindRenderbuffer(r.RENDERBUFFER, i.stencil), r.renderbufferStorage(r.RENDERBUFFER, r.DEPTH_STENCIL, t.width, t.height), t.depthTexture || r.framebufferRenderbuffer(r.FRAMEBUFFER, r.DEPTH_STENCIL_ATTACHMENT, r.RENDERBUFFER, i.stencil))
				...
				this.current = this.unknownFramebuffer, this.viewport = new s.Rectangle
			}, Object.defineProperties(e.prototype, r), e
		}(X),
		yt = function (t) {
		...
		Et = function (t) {
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.contextChange = function () {
				...
				if (this.CONTEXT_UID = this.renderer.CONTEXT_UID, !t.createVertexArray) {
					...
					i.settings.PREFER_ENV === n.ENV.WEBGL_LEGACY && (r = null), r ? (t.createVertexArray = function () {
				...
				for (var t = this._activeGeometry, e = this, r = e.gl, i = 0; i < t.buffers.length; i++) {
					var n = t.buffers[i],
						o = n._glBuffers[this.CONTEXT_UID];
					if (n._updateID !== o.updateID) {
						o.updateID = n._updateID;
						var s = n.index ? r.ELEMENT_ARRAY_BUFFER : r.ARRAY_BUFFER;
						if (r.bindBuffer(s, o.buffer), this._boundBuffer = o, o.byteLength >= n.data.byteLength) r.bufferSubData(s, 0, n.data);
						else {
							var a = n.static ? r.STATIC_DRAW : r.DYNAMIC_DRAW;
							o.byteLength = n.data.byteLength, r.bufferData(s, n.data, a)
						}
					}
				}
				...
				var a = t.buffers,
					...
					u = {},
					l = {};
				for (var d in a) u[d] = 0, l[d] = 0;
				for (var c in h) !h[c].size && e.attributeData[c] ? h[c].size = e.attributeData[c].size : h[c].size || console.warn("PIXI Geometry attribute '" + c + "' size cannot be determined (likely the bound shader does not have the attribute)"), u[h[c].buffer] += h[c].size * xt[h[c].type];
				for (var f in h) {
					var p = h[f],
						v = p.size;
					void 0 === p.stride && (u[p.buffer] === v * xt[p.type] ? p.stride = 0 : p.stride = u[p.buffer]), void 0 === p.start && (p.start = l[p.buffer], l[p.buffer] += v * xt[p.type])
				}
				s = r.createVertexArray(), r.bindVertexArray(s);
				for (var g = 0; g < a.length; g++) {
					var _ = a[g];
					_._glBuffers[i] || (_._glBuffers[i] = new yt(r.createBuffer()), this.managedBuffers[_.id] = _, _.disposeRunner.add(this)), _._glBuffers[i].refCount++
				}
				...
				for (var a in o) {
					...
					if (e.attributeData[a]) {
						s !== l && (r.bindBuffer(r.ARRAY_BUFFER, l.buffer), s = l);
						var d = e.attributeData[a].location;
						if (r.enableVertexAttribArray(d), r.vertexAttribPointer(d, h.size, h.type || r.FLOAT, h.normalized, h.stride, h.start), h.instance) {
				...
				if (s.indexBuffer) {
					...
					2 === a || 4 === a && this.canUseUInt32ElementIndex ? s.instanced ? o.drawElementsInstanced(t, e || s.indexBuffer.data.length, h, (r || 0) * a, i || 1) : o.drawElements(t, e || s.indexBuffer.data.length, h, (r || 0) * a) : console.warn("unsupported index buffer type: uint32")
				} else s.instanced ? o.drawArraysInstanced(t, r, e || s.getSize(), i || 1) : o.drawArrays(t, r, e || s.getSize());
				return this
		...
		Rt = ["precision mediump float;", "void main(void){", "float test = 0.1;", "%forloop%", "gl_FragColor = vec4(0.0);", "}"].join("\n"),
		Ot = 0,
		Mt = {},
		Pt = function t(e, r, o) {
			void 0 === o && (o = "pixi-shader"), this.id = Ot++, this.vertexSrc = e || t.defaultVertexSrc, this.fragmentSrc = r || t.defaultFragmentSrc, this.vertexSrc = this.vertexSrc.trim(), this.fragmentSrc = this.fragmentSrc.trim(), "#version" !== this.vertexSrc.substring(0, 8) && (o = o.replace(/\s+/g, "-"), Mt[o] ? (Mt[o]++, o += "-" + Mt[o]) : Mt[o] = 1, this.vertexSrc = "#define SHADER_NAME " + o + "\n" + this.vertexSrc, this.fragmentSrc = "#define SHADER_NAME " + o + "\n" + this.fragmentSrc, this.vertexSrc = m(this.vertexSrc, i.settings.PRECISION_VERTEX, n.PRECISION.HIGH), this.fragmentSrc = m(this.fragmentSrc, i.settings.PRECISION_FRAGMENT, _())), this.extractData(this.vertexSrc, this.fragmentSrc), this.glPrograms = {}, this.syncUniforms = null
		},
		Ft = {
			defaultVertexSrc: {
				configurable: !0
	...
	Pt.prototype.extractData = function (t, e) {
		var r = g();
		if (r) {
			var i = c(r, t, e);
	...
	}, Pt.prototype.getAttributeData = function (t, e) {
		...
		return r
	}, Pt.prototype.getUniformData = function (t, e) {
		...
		var n = t + e,
			o = r.ProgramCache[n];
		return o || (r.ProgramCache[n] = o = new Pt(t, e, i)), o
	}, Object.defineProperties(Pt, Ft);
	var Dt = function (t, e) {
			this.program = t, this.uniformGroup = e ? e instanceof ut ? e : new ut(e) : new ut({});
			for (var r in t.uniformData) this.uniformGroup.uniforms[r] instanceof Array && (this.uniformGroup.uniforms[r] = new Float32Array(this.uniformGroup.uniforms[r]))
		},
		Nt = {
			uniforms: {
				configurable: !0
	...
	Dt.prototype.checkUniformExists = function (t, e) {
	...
	}, Nt.uniforms.get = function () {
		return this.uniformGroup.uniforms
	}, Dt.from = function (t, e, r) {
		var i = Pt.from(t, e);
		return new Dt(i, r)
	}, Object.defineProperties(Dt.prototype, Nt);
	var Ut = function () {
			this.data = 0, this.blendMode = n.BLEND_MODES.NORMAL, this.polygonOffset = 0, this.blend = !0
		},
		Bt = {
			blend: {
				configurable: !0
	...
	Bt.blend.get = function () {
		return !!(1 & this.data)
	}, Bt.blend.set = function (t) {
		!!(1 & this.data) !== t && (this.data ^= 1)
	}, Bt.offsets.get = function () {
		return !!(2 & this.data)
	}, Bt.offsets.set = function (t) {
		!!(2 & this.data) !== t && (this.data ^= 2)
	}, Bt.culling.get = function () {
		return !!(4 & this.data)
	}, Bt.culling.set = function (t) {
		!!(4 & this.data) !== t && (this.data ^= 4)
	}, Bt.depthTest.get = function () {
		return !!(8 & this.data)
	}, Bt.depthTest.set = function (t) {
		!!(8 & this.data) !== t && (this.data ^= 8)
	}, Bt.clockwiseFrontFace.get = function () {
		return !!(16 & this.data)
	}, Bt.clockwiseFrontFace.set = function (t) {
		!!(16 & this.data) !== t && (this.data ^= 16)
	}, Bt.blendMode.get = function () {
		return this._blendMode
	}, Bt.blendMode.set = function (t) {
		this.blend = t !== n.BLEND_MODES.NONE, this._blendMode = t
	}, Bt.polygonOffset.get = function () {
		return this._polygonOffset
	}, Bt.polygonOffset.set = function (t) {
	...
	var Lt = function (t) {
		function e(r, n, o) {
			var s = Pt.from(r || e.defaultVertexSrc, n || e.defaultFragmentSrc);
			t.call(this, s, o), this.padding = 0, this.resolution = i.settings.FILTER_RESOLUTION, this.enabled = !0, this.autoFit = !0, this.legacy = !!this.program.attributeData.aTextureCoord, this.state = new Ut
		}
		t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e;
		var r = {
				blendMode: {
		...
		return e.prototype.apply = function (t, e, r, i, n) {
			...
			return "varying vec2 vTextureCoord;\n\nuniform sampler2D uSampler;\n\nvoid main(void){\n   gl_FragColor = texture2D(uSampler, vTextureCoord);\n}\n"
		}, Object.defineProperties(e.prototype, r), Object.defineProperties(e, n), e
	}(Dt);
	Lt.SOURCE_KEY_MAP = {};
	var kt = "attribute vec2 aVertexPosition;\nattribute vec2 aTextureCoord;\n\nuniform mat3 projectionMatrix;\nuniform mat3 otherMatrix;\n\nvarying vec2 vMaskCoord;\nvarying vec2 vTextureCoord;\n\nvoid main(void)\n{\n    gl_Position = vec4((projectionMatrix * vec3(aVertexPosition, 1.0)).xy, 0.0, 1.0);\n\n    vTextureCoord = aTextureCoord;\n    vMaskCoord = ( otherMatrix * vec3( aTextureCoord, 1.0)  ).xy;\n}\n",
		...
		Vt = new s.Matrix,
		Xt = function (t, e) {
			this._texture = t, this.mapCoord = new s.Matrix, this.uClampFrame = new Float32Array(4), this.uClampOffset = new Float32Array(2), this._updateID = -1, this.clampOffset = 0, this.clampMargin = void 0 === e ? .5 : e, this.isSimple = !1
		},
		zt = {
			texture: {
				configurable: !0
	...
	zt.texture.get = function () {
		return this._texture
	}, zt.texture.set = function (t) {
		this._texture = t, this._updateID = -1
	}, Xt.prototype.multiplyUvs = function (t, e) {
		void 0 === e && (e = t);
		...
		var i = e.orig,
			n = e.trim;
		n && (Vt.set(i.width / n.width, 0, 0, i.height / n.height, -n.x / n.width, -n.y / n.height), this.mapCoord.append(Vt));
		var o = e.baseTexture,
			s = this.uClampFrame,
	...
	}, Object.defineProperties(Xt.prototype, zt);
	var jt = function (t) {
			function e(e) {
				var r = new s.Matrix;
				t.call(this, kt, Gt), e.renderable = !1, this.maskSprite = e, this.maskMatrix = r
			}
		...
		Ht = function (t) {
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.push = function (t, e) {
				...
				r || (r = this.alphaMaskPool[this.alphaMaskIndex] = [new jt(e)]), r[0].resolution = this.renderer.resolution, r[0].maskSprite = e;
				var i = t.filterArea;
		...
		Yt = function (t) {
			function e(e) {
				t.call(this, e), this.destinationFrame = null, this.sourceFrame = null, this.defaultFrame = null, this.projectionMatrix = new s.Matrix, this.transform = null
			}
		...
		qt = function (t) {
			function e(e) {
				t.call(this, e), this.clearColor = e._backgroundColorRgba, this.defaultMaskStack = [], this.current = null, this.sourceFrame = new s.Rectangle, this.destinationFrame = new s.Rectangle
			}
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.bind = function (t, e, r) {
				...
				if (t) {
					var o = t.baseTexture;
					i = o.resolution, r || (Kt.width = o.realWidth, Kt.height = o.realHeight, r = Kt), e || (e = r), this.renderer.framebuffer.bind(o.framebuffer, r), this.renderer.projection.update(r, e, i, !1), this.renderer.stencil.setMaskStack(o.stencilMaskStack)
				} else i = this.renderer.resolution, r || (Kt.width = n.width, Kt.height = n.height, r = Kt), e || (e = r), n.framebuffer.bind(null, r), this.renderer.projection.update(r, e, i, !0), this.renderer.stencil.setMaskStack(this.defaultMaskStack);
	...
	var Qt = 0,
		$t = function (t) {
			function e(e) {
				t.call(this, e), this.systemCheck(), this.gl = null, this.shader = null, this.program = null, this.cache = {}, this.id = Qt++
			}
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.systemCheck = function () {
				if (!w()) throw new Error("Current environment does not allow unsafe-eval, please use @pixi/unsafe-eval module to enable support.")
			}, e.prototype.contextChange = function (t) {
				...
				return this.cache[e] || (this.cache[e] = E(t, this.shader.program.uniformData)), t.syncUniforms[this.shader.program.id] = this.cache[e], t.syncUniforms[this.shader.program.id]
			}, e.prototype.getSignature = function (t, e) {
				var r = t.uniforms,
					i = [];
		...
		ne = function (t) {
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.contextChange = function (t) {
				this.gl = t, this.blendModes = S(t), this.set(this.defaultState), this.reset()
		...
		oe = function (t) {
			function e(e) {
				t.call(this, e), this.count = 0, this.checkCount = 0, this.maxIdle = i.settings.GC_MAX_IDLE, this.checkCountMax = i.settings.GC_MAX_CHECK_COUNT, this.mode = i.settings.GC_MODE
			}
		...
		ae = function (t) {
			function e(e) {
				t.call(this, e), this.boundTextures = [], this.currentLocation = -1, this.managedTextures = [], this._unknownBoundTextures = !1, this.unknownTexture = new D
			}
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.contextChange = function () {
				var t = this.gl = this.renderer.gl;
				...
				this.emptyTextures = {};
				var i = new se(t.createTexture());
				t.bindTexture(t.TEXTURE_2D, i.texture), t.texImage2D(t.TEXTURE_2D, 0, t.RGBA, 1, 1, 0, t.RGBA, t.UNSIGNED_BYTE, new Uint8Array(4)), this.emptyTextures[t.TEXTURE_2D] = i, this.emptyTextures[t.TEXTURE_CUBE_MAP] = new se(t.createTexture()), t.bindTexture(t.TEXTURE_CUBE_MAP, this.emptyTextures[t.TEXTURE_CUBE_MAP].texture);
				...
				if (t) {
					if (t = t.baseTexture || t, t.valid) {
						...
						this.currentLocation !== e && (this.currentLocation = e, i.activeTexture(i.TEXTURE0 + e)), this.boundTextures[e] !== t && i.bindTexture(t.target, n.texture), n.dirtyId !== t.dirtyId && this.updateTexture(t), this.boundTextures[e] = t
					}
				...
				for (var o = 0; o < i.length; o++) i[o] === t && (this.currentLocation !== o && (r.activeTexture(r.TEXTURE0 + o), this.currentLocation = o), r.bindTexture(r.TEXTURE_2D, this.emptyTextures[t.target].texture), i[o] = null)
			}, e.prototype.initTexture = function (t) {
				var e = new se(this.gl.createTexture());
				...
				if (e.internalFormat = t.format, e.type = t.type, 2 === this.webGLVersion) {
					...
					t.type === r.FLOAT && t.format === r.RGBA && (e.internalFormat = r.RGBA32F), t.type === n.TYPES.HALF_FLOAT && (e.type = r.HALF_FLOAT), e.type === r.HALF_FLOAT && t.format === r.RGBA && (e.internalFormat = r.RGBA16F)
				}
				...
				var i = this,
					n = i.gl;
				if (t = t.baseTexture || t, t._glTextures[this.CONTEXT_UID] && (this.unbind(t), n.deleteTexture(t._glTextures[this.CONTEXT_UID].texture), t.off("dispose", this.destroyTexture, this), delete t._glTextures[this.CONTEXT_UID], !e)) {
					var o = this.managedTextures.indexOf(t); - 1 !== o && r.removeItems(this.managedTextures, o, 1)
				}
			}, e.prototype.updateTextureStyle = function (t) {
				var e = t._glTextures[this.CONTEXT_UID];
				e && (t.mipmap !== n.MIPMAP_MODES.POW2 && 2 === this.webGLVersion || t.isPowerOfTwo ? (e.mipmap = t.mipmap >= 1, e.wrapMode = t.wrapMode) : (e.mipmap = 0, e.wrapMode = n.WRAP_MODES.CLAMP), t.resource && t.resource.style(this.renderer, t, e) || this.setStyle(t, e), e.dirtyStyleId = t.dirtyStyleId)
			}, e.prototype.setStyle = function (t, e) {
				var r = this.gl;
				if (e.mipmap && r.generateMipmap(t.target), r.texParameteri(t.target, r.TEXTURE_WRAP_S, e.wrapMode), r.texParameteri(t.target, r.TEXTURE_WRAP_T, e.wrapMode), e.mipmap) {
					...
					if (i && t.anisotropicLevel > 0 && t.scaleMode === n.SCALE_MODES.LINEAR) {
		...
		le = function (t) {
			...
			return e.prototype.initPlugins = function (t) {
				...
				i = i || t.getLocalBounds(), 0 === i.width && (i.width = 1), 0 === i.height && (i.height = 1);
				var n = Z.create(0 | i.width, 0 | i.height, e, r);
				return ue.tx = -i.x, ue.ty = -i.y, this.render(t, n, !1, ue, !!t.parent), n
			}, e.prototype.destroy = function (t) {
			...
			}, o.backgroundColor.get = function () {
				return this._backgroundColor
			}, o.backgroundColor.set = function (t) {
				this._backgroundColor = t, this._backgroundColorString = r.hex2string(t), r.hex2rgb(t, this._backgroundColorRgba)
			}, Object.defineProperties(e.prototype, o), e
		}(r.EventEmitter),
		de = function (t) {
			function i(o) {
				void 0 === o && (o = {}), t.call(this, "WebGL", o), o = this.options, this.type = n.RENDERER_TYPE.WEBGL, this.gl = null, this.CONTEXT_UID = 0, this.runners = {
					destroy: new e.Runner("destroy"),
					contextChange: new e.Runner("contextChange", 1),
					reset: new e.Runner("reset"),
					update: new e.Runner("update"),
					postrender: new e.Runner("postrender"),
					prerender: new e.Runner("prerender"),
					resize: new e.Runner("resize", 2)
				}, this.globalUniforms = new ut({
					projectionMatrix: new s.Matrix
				}, !0), this.addSystem(Ht, "mask").addSystem(_t, "context").addSystem(ne, "state").addSystem($t, "shader").addSystem(ae, "texture").addSystem(Et, "geometry").addSystem(mt, "framebuffer").addSystem(Wt, "stencil").addSystem(Yt, "projection").addSystem(oe, "textureGC").addSystem(dt, "filter").addSystem(qt, "renderTexture").addSystem(ft, "batch"), this.initPlugins(i.__plugins), o.context ? this.context.initFromContext(o.context) : this.context.initFromOptions({
				...
				}), this.renderingToScreen = !0, r.sayHello(2 === this.context.webGLVersion ? "WebGL 2" : "WebGL 1"), this.resize(this.options.width, this.options.height)
			}
			return t && (i.__proto__ = t), i.prototype = Object.create(t && t.prototype), i.prototype.constructor = i, i.create = function (t) {
				if (r.isWebGLSupported()) return new i(t);
				throw new Error('WebGL unsupported in this browser, use "pixi.js-legacy" for fallback canvas2d support.')
			}, i.prototype.addSystem = function (t, e) {
				e || (e = t.name);
				var r = new t(this);
				if (this[e]) throw new Error('Whoops! The name "' + e + '" is already in use');
				this[e] = r;
				for (var i in this.runners) this.runners[i].add(r);
				return this
				...
				if (this.renderingToScreen = !e, this.runners.prerender.run(), this.emit("prerender"), this.projection.transform = i, !this.context.isLost) {
					...
					this.renderTexture.bind(e), this.batch.currentRenderer.start(), (void 0 !== r ? r : this.clearBeforeRender) && this.renderTexture.clear(), t.render(this), this.batch.currentRenderer.flush(), e && e.baseTexture.update(), this.runners.postrender.run(), this.projection.transform = null,
						this.emit("postrender")
				}
			}, i.prototype.resize = function (e, r) {
				...
				i.__plugins = i.__plugins || {}, i.__plugins[t] = e
			}, i
		}(le),
		ce = function (t) {
			function e() {
	...
	ve.int8View.get = function () {
		return this._int8View || (this._int8View = new Int8Array(this.rawBinaryData)), this._int8View
	}, ve.uint8View.get = function () {
		return this._uint8View || (this._uint8View = new Uint8Array(this.rawBinaryData)), this._uint8View
	}, ve.int16View.get = function () {
		return this._int16View || (this._int16View = new Int16Array(this.rawBinaryData)), this._int16View
	}, ve.uint16View.get = function () {
		return this._uint16View || (this._uint16View = new Uint16Array(this.rawBinaryData)), this._uint16View
	}, ve.int32View.get = function () {
		return this._int32View || (this._int32View = new Int32Array(this.rawBinaryData)), this._int32View
	}, pe.prototype.view = function (t) {
		return this[t + "View"]
	}, pe.prototype.destroy = function () {
		this.rawBinaryData = null, this._int8View = null, this._uint8View = null, this._int16View = null, this._uint16View = null, this._int32View = null, this.uint32View = null, this.float32View = null
	}, pe.sizeOf = function (t) {
		switch (t) {
			case "int8":
			case "uint8":
				return 1;
	...
	var ge = function (t) {
			function e(e) {
				t.call(this, e), this.shaderGenerator = null, this.geometryClass = null, this.vertexSize = null, this.state = Ut.for2d(), this.size = 8e3, this._vertexCount = 0, this._indexCount = 0, this._bufferedElements = [], this._bufferSize = 0, this._shader = null, this._packedGeometries = [], this._packedGeometryPoolSize = 2, this._flushId = 0, this._drawCalls = [];
				for (var r = 0; r < this.size / 4; r++) this._drawCalls[r] = new fe;
			...
			return t && (e.__proto__ = t), e.prototype = Object.create(t && t.prototype), e.prototype.constructor = e, e.prototype.contextChange = function () {
				var t = this.renderer.gl;
				i.settings.PREFER_ENV === n.ENV.WEBGL_LEGACY ? this.MAX_TEXTURES = 1 : (this.MAX_TEXTURES = Math.min(t.getParameter(t.MAX_TEXTURE_IMAGE_UNITS), i.settings.SPRITE_MAX_TEXTURES), this.MAX_TEXTURES = T(this.MAX_TEXTURES, t)), this._shader = this.shaderGenerator.generateShader(this.MAX_TEXTURES);
				...
				if (0 !== this._vertexCount) {
					var t, e, n = this.getAttributeBuffer(this._vertexCount),
						o = this.getIndexBuffer(this._indexCount),
						s = this.renderer.gl,
						a = this,
						h = a._bufferedElements,
						u = a._drawCalls,
						l = a.MAX_TEXTURES,
						d = a._packedGeometries,
						c = a.vertexSize,
						...
						m = 0,
						y = -1;
					_.textureCount = 0, _.start = 0, _.blend = y;
					var x, E = ++D._globalBatch;
					for (x = 0; x < this._bufferSize; ++x) {
						var T = h[x];
						h[x] = null, t = T._texture.baseTexture;
						var b = r.premultiplyBlendMode[t.premultiplyAlpha ? 1 : 0][T.blendMode];
						y !== b && (y = b, e = null, g = l, E++), e !== t && (e = t, t._batchEnabled !== E && (g === l && (E++, g = 0, _.size = v - _.start, _ = u[m++], _.textureCount = 0, _.blend = y, _.start = v), t.touched = f, t._batchEnabled = E, t._id = g, _.textures[_.textureCount++] = t, g++)), this.packInterleavedGeometry(T, n, o, p, v), p += T.vertexData.length / 2 * c, v += T.indices.length
					}
					D._globalBatch = E, _.size = v - _.start, i.settings.CAN_UPLOAD_SAME_BUFFER ? (d[this._flushId]._buffer.update(n.rawBinaryData, 0), d[this._flushId]._indexBuffer.update(o, 0), this.renderer.geometry.updateBuffers()) : (this._packedGeometryPoolSize <= this._flushId && (this._packedGeometryPoolSize++, d[this._flushId] = new this.geometryClass), d[this._flushId]._buffer.update(n.rawBinaryData, 0), d[this._flushId]._indexBuffer.update(o, 0), this.renderer.geometry.bind(d[this._flushId]), this.renderer.geometry.updateBuffers(), this._flushId++);
					var w = this.renderer.texture,
						S = this.renderer.state;
					for (x = 0; x < m; x++) {
						for (var A = u[x], C = A.textureCount, I = 0; I < C; I++) w.bind(A.textures[I], I), A.textures[I] = null;
						S.setBlendMode(A.blend), s.drawElements(A.type, A.size, s.UNSIGNED_SHORT, 2 * A.start)
					}
					this._bufferSize = 0, this._vertexCount = 0, this._indexCount = 0
				}
			}, e.prototype.start = function () {
				this.renderer.state.set(this.state), this.renderer.shader.bind(this._shader), i.settings.CAN_UPLOAD_SAME_BUFFER && this.renderer.geometry.bind(this._packedGeometries[this._flushId])
				...
				var e = r.nextPow2(Math.ceil(t / 8)),
					i = r.log2(e),
					n = 8 * e;
				this._aBuffers.length <= i && (this._iBuffers.length = i + 1);
				var o = this._aBuffers[n];
				return o || (this._aBuffers[n] = o = new pe(n * this.vertexSize * 4)), o
			}, e.prototype.getIndexBuffer = function (t) {
				var e = r.nextPow2(Math.ceil(t / 12)),
					i = r.log2(e),
					n = 12 * e;
				...
				for (var s = e.uint32View, a = e.float32View, h = n / this.vertexSize, u = t.uvs, l = t.indices, d = t.vertexData, c = t._texture.baseTexture._id, f = Math.min(t.worldAlpha, 1), p = f < 1 && t._texture.baseTexture.premultiplyAlpha ? r.premultiplyTint(t._tintRGB, f) : t._tintRGB + (255 * f << 24), v = 0; v < d.length; v += 2) a[n++] = d[v], a[n++] = d[v + 1], a[n++] = u[v], a[n++] = u[v + 1], s[n++] = p, a[n++] = c;
				for (var g = 0; g < l.length; g++) i[o++] = h + l[g]
			}, e
		}(ct),
		_e = function (t, e) {
	...
	_e.prototype.generateShader = function (t) {
		if (!this.programCache[t]) {
			...
			this.defaultGroupCache[t] = ut.from({
				uSamplers: e
			}, !0);
			var i = this.fragTemplate;
			i = i.replace(/%count%/gi, "" + t), i = i.replace(/%forloop%/gi, this.generateSampleSrc(t)), this.programCache[t] = new Pt(this.vertexSrc, i)
		}
		var n = {
		...
		return new Dt(this.programCache[t], n)
...
var _pixi_sprite = function (t, e, i, r, s, h, n) {
	...
	var o = new e.Point,
		...
		u = function (t) {
			...
			return h.prototype._onTextureUpdate = function () {
				this._textureID = -1, this._textureTrimmedID = -1, this._cachedTint = 16777215, this._width && (this.scale.x = i.sign(this.scale.x) * this._width / this._texture.orig.width), this._height && (this.scale.y = i.sign(this.scale.y) * this._height / this._texture.orig.height)
			}, h.prototype._onAnchorUpdate = function () {
				this._transformID = -1, this._transformTrimmedID = -1
			}, h.prototype.calculateVertices = function () {
				var t = this._texture;
				if (this._transformID !== this.transform._worldID || this._textureID !== t._updateID) {
					...
					var e = this.transform.worldTransform,
						...
						x = 0,
						f = 0;
					if (u ? (l = u.x - c._x * _.width, d = l + u.width, f = u.y - c._y * _.height, x = f + u.height) : (l = -c._x * _.width, d = l + _.width, f = -c._y * _.height, x = f + _.height), a[0] = i * l + s * f + n, a[1] = h * f + r * l + o, a[2] = i * d + s * f + n, a[3] = h * f + r * d + o, a[4] = i * d + s * x + n, a[5] = h * x + r * d + o, a[6] = i * l + s * x + n, a[7] = h * x + r * l + o, this._roundPixels)
						for (var g = 0; g < 8; g++) a[g] = Math.round(a[g])
				}
			}, h.prototype.calculateTrimmedVertices = function () {
				...
				var t = this._texture,
					...
					l = -r._y * i.height,
					x = l + i.height;
				e[0] = h * c + o * l + u, e[1] = a * l + n * c + _, e[2] = h * d + o * l + u, e[3] = a * l + n * d + _, e[4] = h * d + o * x + u, e[5] = a * x + n * d + _, e[6] = h * c + o * x + u, e[7] = a * x + n * c + _
			...
			}, h.prototype.getLocalBounds = function (i) {
				...
				var e = this._texture.orig.width,
					...
					r = -e * this.anchor.x,
					s = 0;
				return o.x >= r && o.x < r + e && (s = -i * this.anchor.y, o.y >= s && o.y < s + i)
				...
				return new h(t instanceof r.Texture ? t : r.Texture.from(t, e))
			}, u.roundPixels.set = function (t) {
				this._roundPixels !== t && (this._transformID = -1), this._roundPixels = t
			}, u.roundPixels.get = function () {
				return this._roundPixels
			}, u.width.get = function () {
				return Math.abs(this.scale.x) * this._texture.orig.width
			}, u.width.set = function (t) {
				var e = i.sign(this.scale.x) || 1;
				this.scale.x = e * t / this._texture.orig.width, this._width = t
			}, u.height.get = function () {
				return Math.abs(this.scale.y) * this._texture.orig.height
			}, u.height.set = function (t) {
				var e = i.sign(this.scale.y) || 1;
				this.scale.y = e * t / this._texture.orig.height, this._height = t
			}, u.anchor.get = function () {
				return this._anchor
			}, u.anchor.set = function (t) {
				this._anchor.copyFrom(t)
			}, u.tint.get = function () {
				return this._tint
			}, u.tint.set = function (t) {
				this._tint = t, this._tintRGB = (t >> 16) + (65280 & t) + ((255 & t) << 16)
			}, u.texture.get = function () {
				return this._texture
			}, u.texture.set = function (t) {
				this._texture !== t && (this._texture = t || r.Texture.EMPTY, this._cachedTint = 16777215, this._textureID = -1, this._textureTrimmedID = -1, t && (t.baseTexture.valid ? this._onTextureUpdate() : t.once("update", this._onTextureUpdate, this)))
			}, Object.defineProperties(h.prototype, u), h
		}(h.Container);
	return t.Sprite = u, t
}({}, PIXI, PIXI.utils, PIXI, PIXI, PIXI, PIXI);
Object.assign(this.PIXI, _pixi_sprite);
this.PIXI = this.PIXI || {}, this.PIXI.filters = this.PIXI.filters || {};
var _pixi_filter_displacement = function (t, r, i) {
	"use strict";
	var e = "attribute vec2 aVertexPosition;\n\nuniform mat3 projectionMatrix;\nuniform mat3 filterMatrix;\n\nvarying vec2 vTextureCoord;\nvarying vec2 vFilterCoord;\n\nuniform vec4 inputSize;\nuniform vec4 outputFrame;\n\nvec4 filterVertexPosition( void )\n{\n    vec2 position = aVertexPosition * max(outputFrame.zw, vec2(0.)) + outputFrame.xy;\n\n    return vec4((projectionMatrix * vec3(position, 1.0)).xy, 0.0, 1.0);\n}\n\nvec2 filterTextureCoord( void )\n{\n    return aVertexPosition * (outputFrame.zw * inputSize.zw);\n}\n\nvoid main(void)\n{\n\tgl_Position = filterVertexPosition();\n\tvTextureCoord = filterTextureCoord();\n\tvFilterCoord = ( filterMatrix * vec3( vTextureCoord, 1.0)  ).xy;\n}\n",
		...
		o = function (t) {
			function r(r, o) {
				var a = new i.Matrix;
				r.renderable = !1, t.call(this, e, n, {
				...
				}), this.maskSprite = r, this.maskMatrix = a, null !== o && void 0 !== o || (o = 20), this.scale = new i.Point(o, o)
			}
			...
			return r.prototype.apply = function (t, r, i, e) {
				...
				0 !== o && 0 !== a && (this.uniforms.rotation[0] = n.a / o, this.uniforms.rotation[1] = n.b / o, this.uniforms.rotation[2] = n.c / a, this.uniforms.rotation[3] = n.d / a), t.applyFilter(this, r, i, e)
			}, o.map.get = function () {
	...
	return t.DisplacementFilter = o, t
}({}, PIXI, PIXI);
Object.assign(this.PIXI.filters, _pixi_filter_displacement);
this.PIXI = this.PIXI || {};
var _pixi_app = function (e, i, r) {
	"use strict";
	var t = function e(t) {
			var n = this;
			t = Object.assign({
				forceCanvas: !1
			}, t), this.renderer = r.autoDetectRenderer(t), this.stage = new i.Container, e._plugins.forEach(function (e) {
				e.init.call(n, t)
			})
		},
		n = {
	...
	t.registerPlugin = function (e) {
		...
		n.reverse(), n.forEach(function (e) {
			e.destroy.call(r)
		}), this.stage.destroy(i), this.stage = null, this.renderer.destroy(e), this.renderer = null, this._options = null
	}, Object.defineProperties(t.prototype, n), t._plugins = [];
	var s = function () {};
	return s.init = function (e) {
		var i = this;
		Object.defineProperty(this, "resizeTo", {
			set: function (e) {
				window.removeEventListener("resize", this.resize), this._resizeTo = e, e && (window.addEventListener("resize", this.resize), this.resize())
			},
			get: function () {
				return this._resizeTo
			}
		}), this.resize = function () {
			i._resizeTo && (i._resizeTo === window ? i.renderer.resize(window.innerWidth, window.innerHeight) : i.renderer.resize(i._resizeTo.clientWidth, i._resizeTo.clientHeight))
		}, this._resizeTo = null, this.resizeTo = e.resizeTo || null
	}, s.destroy = function () {
		this.resizeTo = null, this.resize = null
	}, t.registerPlugin(s), e.Application = t, e
}({}, PIXI, PIXI);
